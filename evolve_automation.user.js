...
(function ($) {
  ...
  class Resource {
    ...
    updateData() {
      ...
      if (
        (settings.prestigeWhiteholeEjectEnabled || haveTask("trash")) &&
        this.isEjectable() &&
      ...
      if (
        settings.autoSupply &&
        this.isSupply() &&
        buildings.LakeTransport.count > 0
      ) {
        this.currentSupply =
          game.global.portal.transport.cargo[this._id] * this.supplyVolume;
    ...
    isUseful() {
      ...
      if (
        !this.storeOverflow &&
        this.currentQuantity > this.storageRequired &&
        this.currentCrates + this.currentContainers > 0 &&
        this.calculateRateOfChange({ all: true }) < 0
      ) {
        return false;
      }
      return (
        ...
        this.currentSupply > 0 ||
        (this.storeOverflow &&
          (this.currentCrates < this.autoCratesMax ||
            this.currentContainers < this.autoContainersMax))
      );
    }
    ...
    getBusyWorkers(workersSource, workersCount) {
      if (workersCount > 0) {
        ...
        let usedIncome =
          totalIncome - this.calculateRateOfChange({ all: true });
        if (usedIncome > 0) {
    ...
    isTradable() {
      return (
        game.tradeRatio.hasOwnProperty(this.id) &&
        (this.instance ? this.instance.hasOwnProperty("trade") : false)
      );
    }
    ...
    isCapped() {
      return this.maxQuantity > 0
        ? this.currentQuantity +
            this.rateOfChange * gameTicksPerSecond("mid") >=
            this.maxQuantity
        : false;
    }
    ...
    get usefulRatio() {
      ...
      return (
        this.currentQuantity / Math.min(this.maxQuantity, this.storageRequired)
      );
    }
    ...
    get autoCratesMax() {
      return this._autoCratesMax < 0
        ? Number.MAX_SAFE_INTEGER
        : this._autoCratesMax;
    }

    get autoContainersMax() {
      return this._autoContainersMax < 0
        ? Number.MAX_SAFE_INTEGER
        : this._autoContainersMax;
    }
  ...
  class Power extends Resource {
    updateData() {
      ...
      this.maxQuantity = Object.values(buildings).reduce(
        (net, b) =>
          net +
          (b === buildings.NeutronCitadel
            ? getCitadelConsumption(b.count) -
              getCitadelConsumption(b.stateOnCount)
            : b.stateOffCount * b.powered),
        0
      );
  ...
  class BeltSupport extends Support {
    ...
    updateData() {
      ...
      let maxWorkers =
        settings.autoJobs && jobs.SpaceMiner.autoJobEnabled
  ...
  class Action {
        ...
        if (resources[resourceName]) {
          ...
          if (resourceAmount > 0) {
            this.resourceRequirements.push(
              new ResourceRequirement(resources[resourceName], resourceAmount)
            );
          }

          if (resourceName === "Elerium")
            state.eleriumCosts.push(resourceAmount);
        }
      }
    }
    ...
    click() {
      ...
      this.resourceRequirements.forEach(
        (requirement) =>
      ...
      if (
        ...
        if (
          this.gameMax < Number.MAX_SAFE_INTEGER &&
          this.count + 1 < this.gameMax
        ) {
          GameLog.logSuccess(
            GameLog.Types.multi_construction,
            poly.loc("build_success", [`${this.title} (${this.count + 1})`]),
            ["queue", "building_queue"]
          );
        } else {
          GameLog.logSuccess(
            GameLog.Types.construction,
    ...
    getMissingConsumption() {
      for (let j = 0; j < this.consumption.length; j++) {
        ...
        if (
          ...
          consumptionRate > 0 &&
          resource.rateOfChange < consumptionRate
        ) {
          return resource;
        }
      }
    ...
    getMissingSupport() {
      ...
      if (
        (this === buildings.SpirePort ||
          this === buildings.SpireBaseCamp ||
          this === buildings.SpireMechBay) &&
        this.autoStateSmart
      ) {
        return null;
      }
    ...
    getUselessSupport() {
      ...
      if (
        ...
        this === buildings.StargateTelemetryBeacon
      ) {
        return null;
      }
  ...
  class SpaceDock extends Action {
    ...
    cacheOptions() {
      ...
      let title =
        typeof game.actions.space.spc_gas.star_dock.title === "function"
          ? game.actions.space.spc_gas.star_dock.title()
          : game.actions.space.spc_gas.star_dock.title;
  ...
  class Project extends Action {
    ...
    updateResourceRequirements() {
      ...
      for (let resourceName in adjustedCosts) {
        if (resources[resourceName]) {
          ...
          if (resourceAmount > 0) {
            maxStep = Math.min(
              maxStep,
              resources[resourceName].maxQuantity / (resourceAmount / 100)
            );
            this.resourceRequirements.push(
      ...
      if (this.currentStep > 1) {
        this.resourceRequirements.forEach(
          (req) => (req.quantity *= this.currentStep)
        );
      }
    }
  ...
  class Technology {
    ...
    click() {
      ...
      GameLog.logSuccess(
        GameLog.Types.research,
        poly.loc("research_success", [techIds[this.definition.id].title]),
  ...
  class Race {
    ...
    getHabitability() {
      ...
      switch (this.genus) {
        ...
        case "demonic":
          return game.global.city.biome === "hellscape"
            ? 1
            : game.global.blood.unbound >= 3
            ? getUnsuitedMod()
            : 0;
        case "angelic":
          return game.global.city.biome === "eden"
            ? 1
            : game.global.blood.unbound >= 3
            ? getUnsuitedMod()
            : 0;
  ...
  class Trigger {
    ...
    areRequirementsMet() {
      if (
        ...
        techIds[this.requirementId].isUnlocked()
      ) {
        return true;
      }
      if (
        this.requirementType === "researched" &&
        techIds[this.requirementId].isResearched()
      ) {
        return true;
      }
      if (
        this.requirementType === "built" &&
        (buildingIds[this.requirementId].isMission()
          ? Number(buildingIds[this.requirementId].isComplete())
          : buildingIds[this.requirementId].count) >= this.requirementCount
      ) {
        return true;
      }
      return false;
  ...
  const Fibonacci = (
    (m) => (n) =>
      m[n] ?? (m[n] = Fibonacci(n - 1) + Fibonacci(n - 2))
  )([5, 8]);
  ...
  const unlimitedJobs = [
    ...
    "scavenger",
    "forager",
  ]; // this.definition.max holds zero at evolution stage, and that can mess with settings gui
  ...
  var buildings = {
    ...
    RedForgeHorseshoe: new ForgeHorseshoe(
  ...
  var weightingRules = [
    ...
    [
      ...
      (building) =>
        building === buildings.Mine || building === buildings.CoalMine,
    ...
    [
      ...
      (building) => {
        ...
        if (
          gemsCost > 0 &&
          resources.Soul_Gem.currentQuantity - gemsCost < 10
        ) {
          return true;
        }
      },
      ...
      (building) => {
        if (building === buildings.SlaveMarket) {
          ...
          if (
            ...
            resources.Money.rateOfChange < 25000
          ) {
    ...
    [
      ...
      (building) =>
        ...
        (building !== buildings.RuinsGuardPost ||
          !buildings.RuinsGuardPost.isSmartManaged() ||
          isHellSupressUseful()) &&
        (building !== buildings.BadlandsAttractor ||
          (!buildings.BadlandsAttractor.isSmartManaged() &&
            (building !== buildings.StargateDepot ||
              !buildings.StargateDepot.isSmartManaged()))),
      () => "Still have some non operating buildings",
    ...
    [
      ...
      (building) =>
        building === buildings.GateMission ||
      ...
      () =>
        ...
        (haveTech("mad") ||
          (techIds["tech-mad"].isAffordable(true) &&
            techIds["tech-mad"].resourceRequirements.every((req) =>
              req.resource.isUnlocked()
            ))),
      (building) =>
        !building.is.housing &&
        !building.is.garrison &&
        resourceCost(building, resources.Knowledge) <= 0 &&
        (building !== buildings.OilWell || !game.global.race.terrifying), // Terrifying can't buy oil, keep building rigs
    ...
    [
      () => true,
      (building) =>
        building !== buildings.ForgeHorseshoe &&
        building !== buildings.RedForgeHorseshoe &&
        building.count === 0,
      () => "New building",
    ...
    [
      ...
      (building) =>
        building.is.knowledge && building !== buildings.Wardenclyffe, // We want Wardenclyffe for morale
    ...
    [
      ...
      (building) =>
        building === buildings.StorageYard || building === buildings.Warehouse,
      () => "Still have some unused storage",
      () => settings.buildingWeightingCrateUseless,
    ],
    [
      () =>
        resources.Oil.maxQuantity < resources.Oil.requestedQuantity &&
    ...
    [
      () =>
        resources.Helium_3.maxQuantity < resources.Helium_3.requestedQuantity ||
        resources.Oil.maxQuantity < resources.Oil.requestedQuantity,
      (building) =>
    ...
    [
      () =>
        ...
        poly.hellSupression("gate").rating >= 7500,
  ...
  var RitualManager = {
    ...
    Productions: {
      Farmer: {
        id: "farmer",
        isUnlocked: () =>
          !game.global.race["carnivore"] && !game.global.race["soul_eater"],
      },
      Miner: { id: "miner", isUnlocked: () => true },
      Lumberjack: {
        id: "lumberjack",
        isUnlocked: () => isLumberRace() && !game.global.race["evil"],
      },
    ...
    Productions: normalizeProperties(
      {
        ...
        Steel: {
          id: "Steel",
          unlocked: () =>
            game.global.resource.Steel.display && haveTech("smelting", 2),
    ...
    Fuels: normalizeProperties(
      {
        ...
        Star: {
          id: "Star",
          unlocked: () => haveTech("star_forge", 2),
          cost: [new ResourceProductionCost(resources.StarPower, 1, 0)],
        },
        Inferno: {
          id: "Inferno",
      ...
      switch (espionageId) {
        ...
        case this.Types.Annex.id:
          return (
            gov.hstl <= 50 &&
            gov.unrest >= 50 &&
            game.global.city.morale.current >= 200 + gov.hstl - gov.unrest
          );
  ...
  var WarManager = {
    ...
    get availableGarrison() {
      return game.global.race["rage"]
        ? Math.min(this.maxCityGarrison, this.currentSoldiers - this.wounded)
    ...
    getHellReservedSoldiers() {
      ...
      if (
        ...
        if (game.global.portal.gun_emplacement) {
          soldiers -=
            game.global.portal.gun_emplacement.on *
            (game.global.tech.hell_gun >= 2 ? 2 : 1);
          if (soldiers < 0) {
            soldiers = 0;
          }
        }
    ...
    dragMech(oldId, newId) {
      if (typeof unsafeWindow !== "undefined") {
        ...
        win.Sortable.get(this._listVue.$el).options.onEnd(
          cloneInto(
            { oldDraggableIndex: oldId, newDraggableIndex: newId },
            unsafeWindow
          )
        );
      } else {
        Sortable.get(this._listVue.$el).options.onEnd({
  ...
  var JobManager = {
    ...
    managedPriorityList() {
      return this.priorityList.filter(
        (job) =>
          job.isManaged() &&
          (!(job instanceof CraftingJob) || settings.autoCraftsmen)
      );
    },
  ...
  var BuildingManager = {
    ...
    updateWeighting() {
      ...
      for (let i = 0; i < this.priorityList.length; i++) {
        ...
        for (let j = 0; j < activeRules.length; j++) {
          ...
          if (result) {
            building.extraDescription +=
              activeRules[j][wrDescription](result, building) + "<br>";
    ...
    managedStatePriorityList() {
      return this.statePriorityList.filter(
        (building) => building.hasState() && building.autoStateEnabled
      );
    },
  };
  ...
  var ProjectManager = {
    ...
    updateWeighting() {
      ...
      for (let i = 0; i < this.priorityList.length; i++) {
        ...
        if (
          settings.prestigeMADIgnoreArpa &&
          !haveTech("mad") &&
  ...
  var TriggerManager = {
    ...
    resetTargetTriggers() {
      ...
      for (let i = 0; i < this.priorityList.length; i++) {
        ...
        if (
          (settings.autoResearch || trigger.actionType !== "research") &&
          (settings.autoBuild || trigger.actionType !== "build") &&
          !trigger.complete &&
  ...
  function initialiseState() {
    ...
    for (let [name, costs] of Object.entries(game.craftCost)) {
      if (resources[name]) {
        ...
        for (let i = 0; i < costs.length; i++) {
          resources[name].resourceRequirements.push(
            new ResourceRequirement(resources[costs[i].r], costs[i].a)
          );
        }
    ...
    resources.Crates.resourceRequirements = normalizeProperties([
      () =>
        isLumberRace()
          ? { resource: resources.Plywood, quantity: 10 }
          : { resource: resources.Stone, quantity: 200 },
    ]);
    resources.Containers.resourceRequirements.push(
      new ResourceRequirement(resources.Steel, 125)
    );
    ...
    buildings.SpaceNavBeacon.addResourceConsumption(resources.Red_Support, () =>
      haveTech("luna", 3) ? -1 : 0
    );
    ...
    buildings.RedSpaceport.addResourceConsumption(
      ...
      () => game.actions.space.spc_red.spaceport.support() * -1
    );
    ...
    buildings.RedSpaceport.addResourceConsumption(resources.Food, () =>
      game.global.race["cataclysm"] ? 2 : 25
    );
    buildings.RedTower.addResourceConsumption(resources.Red_Support, () =>
      game.global.race["cataclysm"] ? -2 : -1
    );
    buildings.RedLivingQuarters.addResourceConsumption(
      resources.Red_Support,
      1
    );
    ...
    buildings.RedSpaceBarracks.addResourceConsumption(resources.Food, () =>
      game.global.race["cataclysm"] ? 0 : 10
    );
    ...
    buildings.SunSwarmControl.addResourceConsumption(
      resources.Sun_Support,
      () => game.actions.space.spc_sun.swarm_control.support() * -1
    );
    buildings.SunSwarmSatellite.addResourceConsumption(
      resources.Sun_Support,
      1
    );
    ...
    buildings.BeltSpaceStation.addResourceConsumption(resources.Food, () =>
      game.global.race["cataclysm"] ? 1 : 10
    );
    ...
    buildings.AlphaMiningDroid.addResourceConsumption(
      resources.Alpha_Support,
      1
    );
    buildings.AlphaProcessing.addResourceConsumption(
      resources.Alpha_Support,
      1
    );
    ...
    buildings.AlphaLaboratory.addResourceConsumption(
      resources.Alpha_Support,
      1
    );
    buildings.AlphaExchange.addResourceConsumption(resources.Alpha_Support, 1);
    buildings.AlphaGraphenePlant.addResourceConsumption(
      resources.Alpha_Support,
      1
    );
    ...
    buildings.NebulaHarvestor.addResourceConsumption(
      resources.Nebula_Support,
      1
    );
    buildings.NebulaEleriumProspector.addResourceConsumption(
      resources.Nebula_Support,
      1
    );
    ...
    buildings.GatewayStarbase.addResourceConsumption(
    ...
    buildings.GatewayShipDock.addResourceConsumption(
      resources.Gateway_Support,
      () => buildings.GatewayStarbase.stateOnCount * -0.25
    );

    buildings.BologniumShip.addResourceConsumption(
      resources.Gateway_Support,
      1
    );
    ...
    buildings.StargateStation.addResourceConsumption(
      resources.Gateway_Support,
      -0.5
    );
    buildings.StargateTelemetryBeacon.addResourceConsumption(
      resources.Gateway_Support,
      -0.75
    );
    ...
    buildings.Alien2Foothold.addResourceConsumption(
      resources.Alien_Support,
      -4
    );
    buildings.Alien2Foothold.addResourceConsumption(resources.Elerium, 2.5);
    buildings.Alien2ArmedMiner.addResourceConsumption(
      resources.Alien_Support,
      1
    );
    buildings.Alien2ArmedMiner.addResourceConsumption(resources.Helium_3, 10);
    buildings.Alien2OreProcessor.addResourceConsumption(
      resources.Alien_Support,
      1
    );
    buildings.Alien2Scavenger.addResourceConsumption(
      resources.Alien_Support,
      1
    );
    ...
    buildings.SpirePurifier.addResourceConsumption(
      resources.Spire_Support,
      () => (haveTech("b_stone", 3) ? -1.25 : -1)
    );
  ...
  function resetMarketState() {
    ...
    let priorityList = Object.values(resources)
      .filter((r) => r.isTradable())
      .reverse();
  ...
  function resetStorageState() {
    let defaultState = {
      autoStorageEnabled: true,
      storeOverflow: false,
      _autoCratesMax: -1,
      _autoContainersMax: -1,
    };
  ...
  function resetBuildingState() {
    ...
    BuildingManager.addBuildingToPriorityList(
      buildings.ProximaOrichalcumSphere
    );
    ...
    BuildingManager.addBuildingToPriorityList(
      buildings.GasSpaceDockShipSegment
    );
    ...
    BuildingManager.addBuildingToPriorityList(
      buildings.BlackholeWormholeMission
    );
    ...
    BuildingManager.addBuildingToPriorityList(
      buildings.BlackholeStargateComplete
    ); // Should be powered before Andromeda
    ...
    BuildingManager.addBuildingToPriorityList(
      buildings.StargateTelemetryBeacon
    );
    ...
    BuildingManager.addBuildingToPriorityList(
      buildings.NebulaEleriumProspector
    );
    ...
    BuildingManager.addBuildingToPriorityList(
      buildings.StargateDefensePlatform
    );
  ...
  function resetProductionState() {
    ...
    // Factory settings
    Object.assign(FactoryManager.Productions.LuxuryGoods, {
      enabled: true,
      weighting: 1,
      priority: 2,
    });
    Object.assign(FactoryManager.Productions.Furs, {
      enabled: true,
      weighting: 1,
      priority: 1,
    });
    Object.assign(FactoryManager.Productions.Alloy, {
      enabled: true,
      weighting: 1,
      priority: 3,
    });
    Object.assign(FactoryManager.Productions.Polymer, {
      enabled: true,
      weighting: 1,
      priority: 3,
    });
    Object.assign(FactoryManager.Productions.NanoTube, {
      enabled: true,
      weighting: 4,
      priority: 3,
    });
    Object.assign(FactoryManager.Productions.Stanene, {
      enabled: true,
      weighting: 4,
      priority: 3,
    });

    Object.assign(resources.Plywood, {
      autoCraftEnabled: true,
      craftWeighting: 1,
      craftPreserve: 0,
    });
    Object.assign(resources.Brick, {
      autoCraftEnabled: true,
      craftWeighting: 1,
      craftPreserve: 0,
    });
    Object.assign(resources.Wrought_Iron, {
      autoCraftEnabled: true,
      craftWeighting: 1,
      craftPreserve: 0,
    });
    Object.assign(resources.Sheet_Metal, {
      autoCraftEnabled: true,
      craftWeighting: 2,
      craftPreserve: 0,
    });
    Object.assign(resources.Mythril, {
      autoCraftEnabled: true,
      craftWeighting: 3,
      craftPreserve: 0,
    });
    Object.assign(resources.Aerogel, {
      autoCraftEnabled: true,
      craftWeighting: 3,
      craftPreserve: 0,
    });
    Object.assign(resources.Nanoweave, {
      autoCraftEnabled: true,
      craftWeighting: 10,
      craftPreserve: 0,
    });
    Object.assign(resources.Scarletite, {
      autoCraftEnabled: true,
      craftWeighting: 1,
      craftPreserve: 0,
    });

    Object.assign(DroidManager.Productions.Adamantite, {
      priority: 1,
      weighting: 10,
    });
    Object.assign(DroidManager.Productions.Aluminium, {
      priority: 1,
      weighting: 1,
    });
    Object.assign(DroidManager.Productions.Uranium, {
      priority: -1,
      weighting: 10,
    });
    Object.assign(DroidManager.Productions.Coal, {
      priority: -1,
      weighting: 10,
    });

    Object.values(RitualManager.Productions).forEach(
      (spell) => (spell.weighting = 100)
    );
  ...
  function resetLoggingSettings() {
    ...
    Object.values(GameLog.Types).forEach(
      (log) => (settings[log.settingKey] = true)
    );
  ...
  function updateStateFromSettings() {
    ...
    for (let i = 0; i < MinorTraitManager.priorityList.length; i++) {
      ...
      trait.weighting = parseFloat(
        settings["mTrait_w_" + trait.traitName] ?? trait.weighting
      );
      trait.priority = parseFloat(
    ...
    for (let production of Object.values(FactoryManager.Productions)) {
      ...
      production.weighting = parseFloat(
        settings["production_w_" + production.resource.id] ??
          production.weighting
      );
      production.priority = parseFloat(
        settings["production_p_" + production.resource.id] ??
          production.priority
      );
    }

    for (let fuel of Object.values(SmelterManager.Fuels)) {
      fuel.priority = parseInt(
    ...
    for (let resource of Object.values(resources)) {
      ...
      if (resource.hasStorage()) {
        ...
        resource.storagePriority = parseFloat(
          settings["res_storage_p_" + resource.id] ?? resource.storagePriority
        );
        resource._autoCratesMax = parseInt(
          settings["res_crates_m_" + resource.id] ?? resource._autoCratesMax
        );
        resource._autoContainersMax = parseInt(
          settings["res_containers_m_" + resource.id] ??
            resource._autoContainersMax
        );
      }
      if (resource.isTradable()) {
        resource.marketPriority = parseInt(
          settings["res_buy_p_" + resource.id] ?? resource.marketPriority
        );
        resource.autoBuyEnabled =
          settings["buy" + resource.id] ?? resource.autoBuyEnabled;
        resource.autoBuyRatio = parseFloat(
    ...
    for (let i = 0; i < poly.galaxyOffers.length; i++) {
      let resource = resources[poly.galaxyOffers[i].buy.res];
      resource.galaxyMarketWeighting = parseFloat(
        settings["res_galaxy_w_" + resource.id] ??
          resource.galaxyMarketWeighting
      );
      resource.galaxyMarketPriority = parseFloat(
  ...
  function updateStandAloneSettings() {
    ...
    Object.values(GameLog.Types).forEach((log) =>
      addSetting(log.settingKey, true)
    );
    ...
    settingsSections.forEach((id) =>
      addSetting(id + "SettingsCollapsed", true)
    );
    ...
    if (settings.hasOwnProperty("productionPrioritizeDemanded")) {
      settings.productionFoundryWeighting =
        settings.productionPrioritizeDemanded ? "demanded" : "none";
    }
    settings.challenge_plasmid =
      settings.challenge_mastery || settings.challenge_plasmid; // Merge challenge settings
    if (settings.hasOwnProperty("res_trade_buy_mtr_Food")) {
      MarketManager.priorityList.forEach(
        (res) => (res.autoTradeBuyEnabled = true)
      );
    }
    // Remove old settings
    [
    ...
    [
      ...
      [0, 1, 2].forEach((index) => delete settings[id + index])
    );
    ["res_storage_w_", "res_trade_buy_mtr_", "res_trade_sell_mps_"].forEach(
      (id) =>
        Object.values(resources).forEach(
          (resource) => delete settings[id + resource.id]
        )
    );
    Object.values(projects).forEach(
      (project) => delete settings["arpa_ignore_money_" + project.id]
    );
    Object.values(buildings)
      .filter((building) => !building.isSwitchable())
      .forEach((building) => delete settings["bld_s_" + building._vueBinding]);
  }
  ...
  function isAchievementUnlocked(id, level) {
    ...
    return (
      game.global.stats.achieve[id] &&
      game.global.stats.achieve[id][universe] &&
      game.global.stats.achieve[id][universe] >= level
    );
  }
    ...
    if (settings.evolutionQueueEnabled && settings.evolutionQueue.length > 0) {
      ...
      for (let [settingName, settingValue] of Object.entries(queuedEvolution)) {
        if (typeof settings[settingName] === typeof settingValue) {
          ...
          console.log(
            `Type mismatch during loading queued settings: settings.${settingName} type: ${typeof settings[
              settingName
            ]}, value: ${
  ...
  function autoEvolution() {
    ...
    if (state.evolutionTarget === null) {
      ...
      if (settings.userEvolutionTarget === "auto") {
        ...
        for (let raceGroup of Object.values(genusGroups)) {
          ...
          for (let j = 0; j < raceGroup.length; j++) {
            ...
            if (
              race === races.junker &&
              (achievementLevel < 5 || settings.prestigeType === "bioseed")
            ) {
              continue;
            }
            ...
            if (
              ...
              raceIsGood =
                !race.isGreatnessAchievementUnlocked(achievementLevel);
            } else {
          ...
          if (
            remainingRace !== races.junker &&
            game.global.stats.achieve["mass_extinction"] &&
            remainingRace.getCondition() !== "" &&
            raceSuited === 1
          ) {
      ...
      if (
        ...
        settings.evolutionQueue.length > 0 &&
        (!settings.evolutionQueueRepeat ||
          state.evolutionAttempts < settings.evolutionQueue.length)
      ) {
        return;
      }
    ...
    for (let i = 0; i < state.evolutionTarget.evolutionTree.length; i++) {
      ...
      if (costs["RNA"]) {
        let rnaCost = poly.adjustCosts(
          Number(evolution.definition.cost["RNA"]()) || 0
        );
        maxRNA = Math.max(maxRNA, rnaCost);
      }

      if (costs["DNA"]) {
        let dnaCost = poly.adjustCosts(
          Number(evolution.definition.cost["DNA"]()) || 0
        );
  ...
  function autoUniverseSelection() {
    ...
    if (action !== null) {
      logClick(
        action.children[0],
        `Select universe: ${settings.userUniverseTargetName}`
      );
    }
  }
  ...
  function autoPlanetSelection() {
    ...
    for (let i = 0; i < planets.length; i++) {
      ...
      if (
        planet.trait !== "none" &&
        !isAchievementUnlocked("atmo_" + planet.trait, alevel)
      ) {
        planet.achieve++;
      }
  ...
  function autoCraft() {
    ...
    craftLoop: for (let i = 0; i < state.craftableResourceList.length; i++) {
      let craftable = state.craftableResourceList[i];
      if (
        !craftable.isUnlocked() ||
        !craftable.autoCraftEnabled ||
        craftable === resources.Scarletite
      ) {
        continue;
      }
      ...
      for (let j = 0; j < craftable.resourceRequirements.length; j++) {
        ...
        if (craftable.isDemanded()) {
          ...
          afforableAmount = Math.min(
            afforableAmount,
            resource.currentQuantity / requirement.quantity
          );
        } else if (
          resource.isDemanded() ||
          ...
          afforableAmount = Math.min(
            afforableAmount,
            resource.spareQuantity / requirement.quantity
          );
        } else if (
          ...
          afforableAmount = Math.min(
            afforableAmount,
            Math.ceil(
              (resource.rateOfChange * gameSpeed) / requirement.quantity
            )
          );
        } else {
      ...
      if (afforableAmount >= 1) {
        ...
        for (let j = 0; j < craftable.resourceRequirements.length; j++) {
          let requirement = craftable.resourceRequirements[j];
          requirement.resource.currentQuantity -=
            requirement.quantity * afforableAmount;
        }
      }
    }
  }
    ...
    if (!settings.foreignPacifist) {
      ...
      if (settings.foreignOccupyLast && !haveTech("world_control")) {
        let lastTarget = ["Occupy", "Sabotage"].includes(
          ...
          ? Math.max(...unlockedForeigns)
          : currentTarget.id;
        activeForeigns.find((foreign) => foreign.id === lastTarget).policy =
          readyToUnify ? "Occupy" : "Sabotage";
      }
  ...
  function autoMerc() {
    ...
    if (!haveTask("merc")) {
      ...
      while (
        ...
        resources.Money.spareQuantity >= mercenaryCost &&
        (resources.Money.currentQuantity - mercenaryCost > minMoney ||
  ...
  function autoSpy([activeForeigns, currentTarget]) {
    ...
    if (settings.foreignTrainSpy) {
      ...
      for (let i = 0; i < activeForeigns.length; i++) {
        ...
        if (
          foreignVue.spy_disabled(foreign.id) ||
          foreign.gov.occ ||
          foreign.gov.anx ||
          foreign.gov.buy
        ) {
        ...
        if (
          ...
          resources.Money.maxQuantity >= [865350, 1153800, 1730700][foreign.id]
        ) {
          spiesRequired = 3;
        }
    ...
    for (let i = 0; i < activeForeigns.length; i++) {
      ...
      let espionageMission =
        SpyManager.Types[
          foreign.policy === "Occupy" ? "Sabotage" : foreign.policy
        ];
      if (!espionageMission) {
        continue;
      }
  ...
  function autoBattle([activeForeigns, currentTarget]) {
    ...
    if (
      (m.wounded >
        (1 - settings.foreignAttackHealthySoldiersPercent / 100) *
          m.maxCityGarrison &&
        !game.global.race["rage"]) ||
      (m.currentCityGarrison <
        (settings.foreignAttackLivingSoldiersPercent / 100) *
          m.maxCityGarrison &&
        (!settings.foreignProtectSoldiers || settings.foreignMinAdvantage < 75))
    ) {
      return;
    }
    ...
    if (settings.foreignProtectSoldiers) {
      let armor =
        ((game.global.race.scales ? 2 : 0) + (game.global.tech.armor ?? 0)) *
          (game.global.race.armored ? 4 : 1) -
        (game.global.race.frail ? 1 : 0);
      let protectedBattalion = [5, 10, 25, 50, 999].map((cap, tactic) =>
        armor >= cap
          ? Number.MAX_SAFE_INTEGER
          : (armor - (game.global.city.ptrait === "rage" ? 1 : 0)) *
            (5 - tactic)
      );
      maxBattalion = maxBattalion.map((garrison, tactic) =>
        Math.min(garrison, protectedBattalion[tactic])
      );
    }
    ...
    let requiredBattalion = settings.foreignProtectSoldiers
      ? 0
      : m.maxCityGarrison;
  ...
  function autoHell() {
    ...
    if (
      settings.disableHell ||
      (settings.prestigeType === "ascension" &&
        settings.maxSoulGems &&
        resources.Soul_Gem.currentQuantity >= settings.maxSoulGems)
    ) {
    ...
    if (
      buildings.BadlandsAttractor.isSmartManaged() &&
      game.global.portal.attractor &&
      game.global.portal.fortress.threat < settings.hellAttractorTopThreat &&
      m.hellAssigned > 0
    ) {
    ...
    if (!settings.hellHandlePatrolCount) {
      return;
    }
    ...
    if (
      m.maxSoldiers > settings.hellHomeGarrison + settings.hellMinSoldiers &&
      (m.hellSoldiers > settings.hellMinSoldiers ||
        m.currentSoldiers >=
          (m.maxSoldiers * settings.hellMinSoldiersPercent) / 100)
    ) {
      targetHellSoldiers =
        Math.min(m.currentSoldiers, m.maxSoldiers) - settings.hellHomeGarrison; // Leftovers from an incomplete patrol go to hell garrison
      ...
      let hellGarrison = m.getSoldiersForAttackRating(
        Math.max(0, hellWallsMulti * hellTargetFortressDamage - hellTurretPower)
      ); // don't go below 0
  ...
  function autoJobs() {
    ...
    let farmerIndex =
      isDemonRace() || isHunterRace()
        ? jobList.indexOf(jobs.Hunter)
        : jobList.indexOf(jobs.Farmer);
    let lumberjackIndex =
    ...
    let availableEmployees = jobList.reduce(
    ...
    let minFarmers = 0;
    if (farmerIndex !== -1) {
      let foodRateOfChange = resources.Food.calculateRateOfChange({
        buy: true,
      });
      ...
      if (
        jobList.length === (jobList.indexOf(jobs.Unemployed) === -1 ? 1 : 2)
      ) {
        ...
        resources.Population.currentQuantity > state.lastPopulationCount
      ) {
        ...
        if (populationChange === farmerChange && foodRateOfChange > 0) {
          requiredJobs[farmerIndex] =
            jobList[farmerIndex].count - populationChange;
    ...
    if (settings.autoCraftsmen) {
      ...
      let availableJobs = [];
      craftersLoop: for (let i = 0; i < JobManager.craftingJobs.length; i++) {
        ...
        for (let j = 0; j < resource.resourceRequirements.length; j++) {
          ...
          afforableAmount = Math.min(
            afforableAmount,
            requirement.resource.currentQuantity /
              (requirement.quantity * costMod) /
              2
          );
          lowestRatio = Math.min(
            lowestRatio,
            requirement.resource.storageRatio
          );
        }
        ...
        if (job === jobs.Scarletite) {
          ...
          if (
            afforableAmount < maxScar ||
            (settings.prestigeType === "ascension" && isPillarFinished())
          ) {
      ...
      if (
        ...
        state.otherTargets.length > 0
      ) {
        let scaledWeightings = Object.fromEntries(
          availableJobs.map((job) => [
            job.id,
            (state.otherTargets.find(
              (building) =>
                resourceCost(building, job.resource) >
                job.resource.currentQuantity
            )?.weighting ?? 0) * job.resource.craftWeighting,
          ])
        );
        availableJobs.sort(
          (a, b) =>
    ...
    for (let i = 0; i < 3; i++) {
      for (let j = 0; j < jobList.length; j++) {
        ...
        let currentBreakpoint =
          job === jobs.Hunter && isDemonRace() && isLumberRace()
            ? jobs.Lumberjack.breakpointEmployees(i)
            : job.breakpointEmployees(i);
        let jobsToAssign = Math.min(
          availableEmployees,
          Math.max(minEmployees, currentEmployees, currentBreakpoint)
        );
        ...
        if (job === jobs.Entertainer && !haveTech("superstar")) {
          ...
          let entertainerMorale =
            game.global.tech["theatre"] + (game.global.race["musical"] ? 1 : 0);
          let moraleExtra =
            game.global.city.morale.potential -
            game.global.city.morale.cap -
            taxBuffer;
        ...
        if (job === jobs.CementWorker) {
          let stoneRateOfChange =
            resources.Stone.calculateRateOfChange({ buy: true }) +
            job.count * 3 -
            5;
          if (game.global.race["smoldering"] && settings.autoQuarry) {
            stoneRateOfChange += resources.Chrysotile.calculateRateOfChange({
              buy: true,
            });
          }
          jobsToAssign = Math.min(
    ...
    if (splitJobs.length > 0) {
      ...
      splitJobs.forEach((jobDetails) => {
        ...
        jobAdjustments[jobDetails.jobIndex] =
          minEmployees - jobList[jobDetails.jobIndex].count;
      });

      // Bring them all up to required breakpoints, one each at a time
      let splitSorter = (a, b) =>
        requiredJobs[a.jobIndex] / a.weighting -
          requiredJobs[b.jobIndex] / b.weighting || a.jobIndex - b.jobIndex;
    ...
    for (let i = 0; i < jobAdjustments.length; i++) {
      ...
      if (adjustment < 0) {
        ...
        log(
          "autoJobs",
          "Adjusting job " + jobList[i]._originalId + " down by " + adjustment
        );
      }
    }
    ...
    for (let i = 0; i < jobAdjustments.length; i++) {
      ...
      if (adjustment > 0) {
        ...
        log(
          "autoJobs",
          "Adjusting job " + jobList[i]._originalId + " up by " + adjustment
        );
      }
    }
    ...
    if (settings.jobSetDefault && minDefault === 0) {
      ...
      if (
        ...
        requiredJobs[crystalMinerIndex] > 0
      ) {
        jobs.CrystalMiner.setAsDefault();
      } else if (
        jobs.Scavenger.isManaged() &&
        requiredJobs[scavengerIndex] > 0
      ) {
  ...
  function autoTax() {
    ...
    let optimalTax = resources.Money.isDemanded()
      ? maxTaxRate
      : Math.round(
  ...
  function autoPylon() {
    ...
    let spells = Object.values(RitualManager.Productions).filter(
      (spell) => spell.isUnlocked() && spell.weighting > 0
    );
    ...
    for (let spell of spells) {
      ...
      resources.Mana.rateOfChange += RitualManager.manaCost(
        RitualManager.currentSpells(spell)
      );
    }
    let manaToUse =
    ...
    while (remainingSpells.length > 0) {
      ...
      let cost =
        RitualManager.manaCost(amount + 1) - RitualManager.manaCost(amount);
    ...
    let pylonDeltas = spells.map(
      (spell) => pylonAdjustments[spell.id] - RitualManager.currentSpells(spell)
    );

    spells.forEach(
      (spell, index) =>
        pylonDeltas[index] < 0 &&
        RitualManager.decreaseRitual(spell, pylonDeltas[index] * -1)
    );
    spells.forEach(
      (spell, index) =>
        pylonDeltas[index] > 0 &&
        RitualManager.increaseRitual(spell, pylonDeltas[index])
    );
  }
  ...
  function autoQuarry() {
    ...
    let newAsbestos = Math.round(
      (chrysotileWeigth / (chrysotileWeigth + stoneWeigth)) * 100
    );

    if (newAsbestos !== QuarryManager.currentAsbestos()) {
      QuarryManager.increaseAsbestos(
        newAsbestos - QuarryManager.currentAsbestos()
      );
    }
  }
  ...
  function autoSmelter() {
    ...
    let smelterIronCount = SmelterManager.smeltingCount(
      SmelterManager.Productions.Iron
    );
    let smelterSteelCount = SmelterManager.smeltingCount(
    ...
    if (!game.global.race["forge"]) {
      ...
      for (let i = 0; i < fuels.length; i++) {
        ...
        if (
          fuel === SmelterManager.Fuels.Inferno &&
          fuels[i + 1] === SmelterManager.Fuels.Oil &&
        ...
        fuel.cost.forEach((productionCost) => {
          ...
          let remainingRateOfChange =
            resource.calculateRateOfChange({ buy: true }) +
            SmelterManager.fueledCount(fuel) * productionCost.quantity;
        ...
        fuelAdjust[fuel.id] =
          maxAllowedUnits - SmelterManager.fueledCount(fuel);
      }
      ...
      while (remainingFactories > 0) {
        ...
        for (
          ...
          production.cost.forEach((resourceCost) => {
            ...
            let rate =
              resourceCost.resource.calculateRateOfChange({ buy: true }) +
              previousCost -
              currentCost;
            ...
            if (
              ...
              (resourceCost.resource.isDemanded() ||
                resourceCost.resource.storageRatio <
          ...
          if (
            ...
            resources.Neutronium.currentQuantity < 250
          ) {
            actualRequiredFactories = 0;
          }
  ...
  function autoGraphenePlant() {
    ...
    for (let fuel of sortedFuel) {
      ...
      let rateOfChange =
        resource.calculateRateOfChange({ buy: true }) +
        fuel.cost.quantity * GrapheneManager.fueledCount(fuel);
      if (resource.storageRatio < 0.98) {
  ...
  function autoSupply() {
    if (
      buildings.LakeTransport.stateOnCount < 1 ||
      buildings.LakeBireme.stateOnCount < 1
    ) {
      return;
    }
      ...
      for (let i = 0; i < resourcesBySupplyValue.length; i++) {
        ...
        if (resource.isCraftable()) {
          if (resource.currentQuantity > resource.storageRequired / keepRatio) {
            allowedSupply = Math.max(
              0,
              Math.floor(
                (resource.currentQuantity -
                  resource.storageRequired / keepRatio) /
                  resource.supplyVolume
              )
            );
          }
        } else {
    ...
    let transportDeltas = Object.entries(transportAdjustments).map(
      ([id, adjust]) => ({
        res: resources[id],
        delta: adjust - game.global.portal.transport.cargo[id],
      })
    );

    transportDeltas.forEach(
      (item) => item.delta < 0 && item.res.decreaseSupply(item.delta * -1)
    );
    transportDeltas.forEach(
      (item) => item.delta > 0 && item.res.increaseSupply(item.delta)
    );
  }
  ...
  function autoMassEjector() {
    ...
    for (let i = 0; i < resourcesByAtomicMass.length; i++) {
      ...
      let keepRatio =
        enabledEjectors >= settings.prestigeWhiteholeEjectAllCount
          ? 0.05
          : 0.985;
      ...
      keepRatio = Math.max(
        keepRatio,
        resource.requestedQuantity / resource.maxQuantity + 0.01
      );

      let allowedEject = 0;
      if (resource.isCraftable()) {
        if (resource.currentQuantity > resource.storageRequired / keepRatio) {
          allowedEject = Math.max(
            0,
            Math.floor(
              resource.currentQuantity - resource.storageRequired / keepRatio
            )
          );
        }
      } else {
        if (resource.storageRatio > keepRatio + 0.01) {
          allowedEject = Math.max(
            1,
            Math.ceil(
              resource.calculateRateOfChange({ buy: true, supply: true })
            ),
            Math.ceil(
              (resource.storageRatio - keepRatio) * resource.maxQuantity
            )
    ...
    if (
      remaining > 0 &&
      (settings.prestigeWhiteholeEjectExcess ||
        (game.global.race["decay"] && settings.prestigeWhiteholeDecayRate > 0))
    ) {
      for (let i = 0; i < resourcesByAtomicMass.length; i++) {
        if (remaining <= 0) {
          break;
        ...
        if (game.global.race["decay"] && !resource.isDemanded()) {
          ejectableAmount = Math.max(
            ejectableAmount,
            Math.floor(
              resource.currentDecay * settings.prestigeWhiteholeDecayRate
            )
          );
        }
          ...
          ejectableAmount = Math.max(
            ...
            Math.ceil(
              resource.currentQuantity -
                ...
                resource.calculateRateOfChange({
                  buy: true,
                  sell: true,
                  decay: true,
                  supply: true,
    ...
    let ejectorDeltas = Object.entries(ejectorAdjustments).map(
      ([id, adjust]) => ({
        res: resources[id],
        delta: adjust - game.global.interstellar.mass_ejector[id],
      })
    );

    ejectorDeltas.forEach(
      (item) => item.delta < 0 && item.res.decreaseEjection(item.delta * -1)
    );
    ejectorDeltas.forEach(
      (item) => item.delta > 0 && item.res.increaseEjection(item.delta)
    );
  }
  ...
  function isAscensionPrestigeAvailable() {
    return (
      ...
      buildings.SiriusAscend.isUnlocked() &&
      isPillarFinished()
    );
  }
  ...
  function isDemonicPrestigeAvailable() {
    return (
      ...
      haveTech("waygate", 3) &&
      (!settings.autoMech ||
        (!MechManager.isActive &&
          MechManager.mechsPotential <= settings.prestigeDemonicPotential)) &&
      techIds["tech-demonic_infusion"].isUnlocked()
    );
  }
  ...
  function isPillarFinished() {
    return (
      ...
      game.global.race.universe === "micro" ||
      game.global.pillars[game.global.race.species] >= game.alevel()
    );
  }
  ...
  function autoAssembleGene() {
    ...
    let nextTickKnowledge =
      ...
      resources.Knowledge.rateOfChange * gameTicksPerSecond("mid");
    ...
    for (let i = 0; i < MarketManager.priorityList.length; i++) {
      ...
      if (
        ...
        if (resource.storageRatio > resource.autoSellRatio) {
          ...
          maxAllowedUnits = Math.min(
            maxAllowedUnits,
            Math.floor(resource.calculateRateOfChange({ all: true }) * 2)
          ); // If resource is full then sell up to 2 seconds worth of production
        }
      ...
      while (remainingFreighters > 0) {
        ...
        for (
          ...
          if (
            ...
            sellResource.storageRatio < settings.productionFactoryMinIngredients
          ) {
  ...
  function autoBuild() {
    ...
    for (let i = 0; i < state.triggerTargets.length; i++) {
      ...
      if (
        building instanceof Action &&
        building.click() &&
        building.consumption.length > 0
      ) {
        return;
      }
    }
    ...
    buildingsLoop: for (let i = 0; i < buildingList.length; i++) {
      ...
      if (
        ...
        !building.resourceRequirements.some(
          (requirement) => requirement.resource.storageRatio > 0.98
        )
      ) {
        for (let j = 0; j < buildingList.length; j++) {
          ...
          if (!estimatedTime[other._vueBinding]) {
            ...
            for (let k = 0; k < other.resourceRequirements.length; k++) {
              ...
              let totalRateOfCharge = resource.calculateRateOfChange({
                buy: true,
              });
              if (totalRateOfCharge > 0) {
                estimatedTime[other._vueBinding][resource.id] =
            ...
            estimatedTime[other._vueBinding].total = Math.max(
              0,
              ...Object.values(estimatedTime[other._vueBinding])
            );
          }
          ...
          for (let k = 0; k < building.resourceRequirements.length; k++) {
            ...
            let otherRequirement = other.resourceRequirements.find(
              (resourceRequirement) => resourceRequirement.resource === resource
            );
            ...
            if (
              resource.currentQuantity >=
              otherRequirement.quantity + thisRequirement.quantity
            ) {
              continue;
            }
            ...
            if (
              thisRequirement.quantity <=
              (estimatedTime[other._vueBinding].total -
                estimatedTime[other._vueBinding][resource.id]) *
                resource.calculateRateOfChange({ buy: true })
            ) {
              continue;
      ...
      if (building.click()) {
        ...
        if (
          ...
          (settings.prestigeWhiteholeSaveGems &&
            settings.prestigeType === "whitehole" &&
            resourceCost(building, resources.Soul_Gem) > 0)
        ) {
          return;
        }
  ...
  function isTechAllowed(tech) {
    ...
    if (
      ...
      (!settings.prestigeWhiteholeStabiliseMass ||
        settings.prestigeType === "whitehole")
    ) {
      return false;
    }
  ...
  function autoPower() {
    ...
    for (let i = 0; i < buildingList.length; i++) {
      ...
      for (let j = 0; j < building.consumption.length; j++) {
        ...
        if (
          building._tab === "space" &&
          (resourceType.resource === resources.Oil ||
            resourceType.resource === resources.Helium_3)
        ) {
          consumptionRate = game.fuel_adjust(consumptionRate, true);
        }
        if (
          (building._tab === "interstellar" || building._tab === "galaxy") &&
          (resourceType.resource === resources.Deuterium ||
            resourceType.resource === resources.Helium_3) &&
          building !== buildings.AlphaFusion
        ) {
          consumptionRate = game.int_fuel_adjust(consumptionRate);
        }
        ...
        if (
          ...
          resourceType.resource.rateOfChange +=
            consumptionRate * building.stateOnCount;
        }
      }
    }
    ...
    if (
      (buildings.DwarfEleriumContainer.count > 0 &&
        buildings.DwarfEleriumContainer.isSmartManaged()) ||
      (buildings.StargateDepot.count > 0 &&
        buildings.StargateDepot.isSmartManaged())
    ) {
      let container = getStorage(
        "Elerium",
        buildings.DwarfEleriumContainer,
        "space_dwarf_elerium_contain_title",
        true
      );
      let depot = getStorage(
        "Elerium",
        buildings.StargateDepot,
        "galaxy_gateway_depot",
        true
      );

      let baseElerium =
        resources.Elerium.maxQuantity -
        container * buildings.DwarfEleriumContainer.stateOnCount -
        depot * buildings.StargateDepot.stateOnCount;
      let maxElerium =
        resources.Elerium.maxQuantity +
        container * buildings.DwarfEleriumContainer.stateOffCount +
        depot * buildings.StargateDepot.stateOffCount;
      let maxAffordable = Math.max.apply(
        Math,
        state.eleriumCosts.filter((cost) => cost <= maxElerium)
      );

      depotStateOn = Math.min(
        buildings.StargateDepot.count,
        Math.max(0, Math.ceil((maxAffordable - baseElerium) / depot))
      );
      containerStateOn = Math.min(
        buildings.DwarfEleriumContainer.count,
        Math.max(
          0,
          Math.ceil(
            (maxAffordable - (baseElerium + depot * depotStateOn)) / container
          )
        )
      );
    }
    ...
    for (let i = 0; i < buildingList.length; i++) {
      ...
      if (building.is.smart && building.autoStateSmart) {
        if (resources.Power.currentQuantity <= resources.Power.maxQuantity) {
          ...
          if (
            ...
            let stationStorage = parseFloat(
              game.breakdown.c.Elerium[game.loc("space_belt_station_title")] ??
                0
            );
            let extraStations = Math.floor(
              (resources.Elerium.maxQuantity -
                resources.Elerium.storageRequired) /
                stationStorage
            );
            let minersNeeded =
              buildings.BeltEleriumShip.stateOnCount * 2 +
            ...
            availablePower <
              building.powered * maxStateOn +
                (
                  ...
                  Math.min(2, buildings.LakeHarbour.count)
          ) {
            maxStateOn = 0;
          }
          // Don't bother powering harbour if we have power for only one
          if (
            building === buildings.LakeHarbour &&
            maxStateOn === 1 &&
            building.count > 1
          ) {
            maxStateOn = 0;
        ...
        if (
          ...
          settings.prestigeEnabledBarracks < 100 &&
          !WarManager.isForeignUnlocked() &&
          buildings.GasSpaceDockShipSegment.count < 90 &&
          buildings.DwarfWorldController.count < 1
        ) {
          maxStateOn = Math.ceil(
            (maxStateOn * settings.prestigeEnabledBarracks) / 100
          );
        }
        ...
        if (building === buildings.RuinsGuardPost) {
          if (isHellSupressUseful()) {
            let postRating =
              game.armyRating(1, "hellArmy", 0) *
              (game.global.race["holy"] ? 1.25 : 1);
            // 1 extra power to compensate rounding errors, 100 extra to compensate heling drinf of rage races
            let postAdjust =
              ((game.global.race["rage"] ? 5100 : 5001) -
                poly.hellSupression("ruins").rating) /
              postRating;
            if (haveTech("hell_gate")) {
              postAdjust = Math.max(
                postAdjust,
                ((game.global.race["rage"] ? 7600 : 7501) -
      ...
      for (let j = 0; j < building.consumption.length; j++) {
        ...
        if (resourceType.rate > 0) {
          if (resourceType.resource === resources.Food) {
            ...
            resourceType.resource.storageRatio > 0.01
          ) {
          ...
          maxStateOn = Math.min(
            maxStateOn,
            resourceType.resource.calculateRateOfChange({ buy: true }) /
              resourceType.rate
          );
        }
      }
      ...
      if (building === buildings.NeutronCitadel) {
        ...
        availablePower -=
          evolve.actions.interstellar.int_sirius.ascension_trigger.powered() *
          maxStateOn;
      } else {
    ...
    if (manageSpire && resources.Spire_Support.rateOfChange > 0) {
      ...
      const canBuild = (building, checkSmart) =>
        ...
        resources.Money.maxQuantity >=
          resourceCost(building, resources.Money) &&
      ...
      for (let targetMech = maxBay; targetMech >= 0; targetMech--) {
        ...
        let missingStorage =
          targetPort > buildings.SpirePort.count
            ? buildings.SpirePort
            : targetCamp > buildings.SpireBaseCamp.count
        ...
        if (missingStorage) {
          ...
          for (let i = maxBay; i >= 0; i--) {
            let [storageSupplies, storagePort, storageCamp] =
              getBestSupplyRatio(spireSupport - i, maxPorts, maxCamps);
  ...
  function getBestSupplyRatio(support, maxPorts, maxCamps) {
    ...
    for (let i = 0; i < support; i++) {
      let maxSupplies =
        Math.min(support - i, maxPorts) * (1 + Math.min(i, maxCamps) * 0.4);
  ...
  function expandStorage(storageToBuild) {
    ...
    resources.Crates.resourceRequirements.forEach(
      (requirement) =>
    ...
    resources.Containers.resourceRequirements.forEach(
      (requirement) =>
    ...
    if (
      ...
      if (
        ...
        buildings.Library.resourceRequirements.some(
          (requirement) =>
            requirement.resource === resources.Plywood &&
            requirement.quantity > resources.Plywood.currentQuantity
        ) &&
        resources.Crates.maxQuantity !== buildings.StorageYard.count * 10
      ) {
    ...
    if (resources.Crates.currentQuantity === 0) {
      let cratesToBuild = Math.min(
        ...
        Math.ceil(missingStorage / poly.crateValue())
      );
      ...
      resources.Crates.resourceRequirements.forEach(
        (requirement) =>
          (requirement.resource.currentQuantity -=
            requirement.quantity * cratesToBuild)
      );
    ...
    if (missingStorage > 0) {
      let containersToBuild = Math.min(
        ...
        Math.ceil(missingStorage / poly.containerValue())
      );
      ...
      resources.Containers.resourceRequirements.forEach(
        (requirement) =>
          (requirement.resource.currentQuantity -=
            requirement.quantity * containersToBuild)
      );
  ...
  function autoStorageBuildings() {
    ...
    let storageList = StorageManager.priorityList.filter(
    ...
    let buildingsList = [];
    const addList = (list) => {
      let resGroups = Object.fromEntries(
        storageList.map((res) => [res.id, []])
      );
      list.forEach((obj) =>
        storageList.find(
          (res) => resourceCost(obj, res) && resGroups[res.id].push(obj)
        )
      );
      Object.values(resGroups).forEach((list, res) =>
        list.sort(
          (a, b) =>
            resourceCost(b, storageList[res]) -
            resourceCost(a, storageList[res])
        )
      );
    ...
    for (let i = 0; i < storageList.length; i++) {
      ...
      if (settings.storageSafeReassign || resource.storeOverflow) {
        storageAdjustments[resource.id] = {
          crate: resource.currentCrates,
          container: resource.currentContainers,
          amount: resource.maxQuantity,
        };
        let freeStorage =
          resource.maxQuantity -
          resource.currentQuantity *
            (resource.storeOverflow ? overMult : bufferMult);
        // Check for minimum containers here
        if (resource.currentContainers > 0 && freeStorage > containerVolume) {
          let extraContainers = Math.min(
            resource.currentContainers,
            Math.floor(freeStorage / containerVolume)
          );

          storageAdjustments[resource.id].amount -=
            extraContainers * containerVolume;
        ...
        if (resource.currentCrates > 0 && freeStorage > crateVolume) {
          let extraCrates = Math.min(
            resource.currentCrates,
            Math.floor(freeStorage / crateVolume)
          );
        ...
        storageAdjustments[resource.id] = {
          ...
          amount:
            resource.maxQuantity -
            (resource.currentCrates * crateVolume +
              resource.currentContainers * containerVolume),
        };
    ...
    nextBuilding: for (let i = 0; i < buildingsList.length; i++) {
      ...
      for (let j = 0; j < building.resourceRequirements.length; j++) {
        ...
        let missingStorage =
          quantity * bufferMult - storageAdjustments[resource.id].amount;
        currentAssign[resource.id] = { crate: 0, container: 0 };
        if (remainingCrates > 0) {
          let assignCrates = Math.min(
            Math.ceil(missingStorage / crateVolume),
            remainingCrates,
            resource.autoCratesMax
          );
        ...
        if (missingStorage > 0 && remainingContainers > 0) {
          let assignContainer = Math.min(
            Math.ceil(missingStorage / containerVolume),
            remainingContainers,
            resource.autoContainersMax
          );
      ...
      for (let id in currentAssign) {
        ...
        storageAdjustments[id].amount +=
          currentAssign[id].crate * crateVolume +
          currentAssign[id].container * containerVolume;
      }
    ...
    for (let id in storageAdjustments) {
      ...
      if (
        resource.storeOverflow &&
        resource.currentQuantity * overMult > storageAdjustments[id].amount
      ) {
        let missingStorage =
          resource.currentQuantity * overMult - storageAdjustments[id].amount;
        if (totalCrates > 0) {
  ...
  function autoStorage() {
    ...
    for (let i = 0; i < storageList.length; i++) {
      storageAdjustments.push({
        resource: storageList[i],
        adjustCrates: 0,
        adjustContainers: 0,
      });
    }
    ...
    for (let i = 0; i < storageList.length; i++) {
      ...
      let calculatedContainers =
        resource.currentContainers + adjustment.adjustContainers;
      ...
      if (resource.storeOverflow) {
        extraStorageRequired = Math.max(
          1,
          extraStorageRequired,
          resource.currentQuantity * 1.02 - rawStorage
        );
      }
      ...
      if (
        containersStorage > 0 &&
        (extraStorage - containerVolume > extraStorageRequired ||
          calculatedContainers > resource.autoContainersMax)
      ) {
        let removedContainers = Math.max(
          calculatedContainers - resource.autoContainersMax,
          Math.min(
            calculatedContainers,
            Math.floor((extraStorage - extraStorageRequired) / containerVolume)
          )
        );
      ...
      if (
        cratesStorage > 0 &&
        (extraStorage - crateVolume > extraStorageRequired ||
          calculatedCrates > resource.autoCratesMax)
      ) {
        let removedCrates = Math.max(
          calculatedCrates - resource.autoCratesMax,
          Math.min(
            calculatedCrates,
            Math.floor((extraStorage - extraStorageRequired) / crateVolume)
          )
        );
      ...
      if (missingStorage > 0) {
        ...
        let maxContainersToUnassign =
          resource.autoContainersMax - calculatedContainers;
        let availableStorage =
          Math.min(maxCratesToUnassign, totalCrates) * crateVolume +
          Math.min(maxContainersToUnassign, totalContainers) * containerVolume;
        ...
        if (availableStorage < missingStorage) {
          for (let j = storageList.length - 1; j > i; j--) {
            let otherFreeStorage =
              storageList[j].maxQuantity -
              storageList[j].currentQuantity +
              storageAdjustments[j].adjustCrates * crateVolume +
              storageAdjustments[j].adjustContainers * containerVolume;
            let otherCalculatedCrates =
              storageList[j].currentCrates + storageAdjustments[j].adjustCrates;
            let otherCalculatedContainers =
              storageList[j].currentContainers +
              storageAdjustments[j].adjustContainers;

            // Unassign crates
            if (maxCratesToUnassign > 0 && otherCalculatedCrates > 0) {
              let missingCrates = Math.ceil(missingStorage / crateVolume);
              let cratesToUnassign = Math.min(
                otherCalculatedCrates,
                missingCrates,
                maxCratesToUnassign
              );

              if (
                settings.storageSafeReassign ||
                storageList[j].storeOverflow
              ) {
            ...
            if (
              maxContainersToUnassign > 0 &&
              otherCalculatedContainers > 0 &&
              missingStorage > 0
            ) {
              let missingContainers = Math.ceil(
                missingStorage / containerVolume
              );
              let containersToUnassign = Math.min(
                otherCalculatedContainers,
                missingContainers,
                maxContainersToUnassign
              );
              ...
              if (
                ...
                let emptyContainers = Math.floor(
                  otherFreeStorage / containerVolume
                );
                containersToUnassign = Math.min(
                  containersToUnassign,
                  emptyContainers
                );
              }
    ...
    storageAdjustments.forEach((adjustment) => {
      if (adjustment.adjustCrates < 0) {
        StorageManager.unassignCrate(
          adjustment.resource,
          adjustment.adjustCrates * -1
        );
        adjustment.resource.maxQuantity -=
          adjustment.adjustCrates * -1 * crateVolume;
      ...
      if (adjustment.adjustContainers < 0) {
        StorageManager.unassignContainer(
          adjustment.resource,
          adjustment.adjustContainers * -1
        );
        adjustment.resource.maxQuantity -=
          adjustment.adjustContainers * -1 * containerVolume;
        resources.Containers.currentQuantity +=
          adjustment.adjustContainers * -1;
      }
    });
    ...
    storageAdjustments.forEach((adjustment) => {
      if (adjustment.adjustCrates > 0) {
        StorageManager.assignCrate(
          adjustment.resource,
          adjustment.adjustCrates
        );
        adjustment.resource.maxQuantity +=
          adjustment.adjustCrates * crateVolume;
        resources.Crates.currentQuantity -= adjustment.adjustCrates;
      }
      if (adjustment.adjustContainers > 0) {
        StorageManager.assignContainer(
          adjustment.resource,
          adjustment.adjustContainers
        );
        adjustment.resource.maxQuantity +=
          adjustment.adjustContainers * containerVolume;
  ...
  function adjustTradeRoutes() {
    let tradableResources = MarketManager.priorityList
      ...
      .sort(
        (a, b) =>
          (b.storageRatio > 0.99 ? b.tradeSellPrice * 1000 : b.usefulRatio) -
          (a.storageRatio > 0.99 ? a.tradeSellPrice * 1000 : a.usefulRatio)
      );
  ...
  function autoFleet() {
    ...
    Object.values(def).forEach((assigned) =>
      Object.entries(assigned).forEach(
        ([ship, count]) => (allFleets[fleetIndex[ship]].count += count)
      )
    );
      ...
      if (powerToReserve <= 0) {
        let sets = availableShips.map((amount, idx) => [
          ...Array(
            Math.min(
              amount,
              Math.floor((fleetWreck + (minPower - 0.1)) / allFleets[idx].power)
            ) + 1
          ).keys(),
        ]);
  ...
  function autoMech() {
    ...
    if (
      ...
      let missingSupplies =
        resources.Supply.maxQuantity - resources.Supply.currentQuantity;
    ...
    if (
      ...
      if (buildings.Food.isClickable()) {
        resources.Food.rateOfChange +=
          resPerClick *
          settings.buildingClickPerTick *
          (haveTech("conjuring", 1) ? 10 : 1);
      }
      if (buildings.Lumber.isClickable()) {
        resources.Lumber.rateOfChange +=
          resPerClick *
          settings.buildingClickPerTick *
          (haveTech("conjuring", 2) ? 10 : 1);
      }
      if (buildings.Stone.isClickable()) {
  ...
  function requiestStorageFor(list) {
    ...
    for (let i = 0; i < list.length; i++) {
      let obj = list[i];
      let unaffordableReq = obj.resourceRequirements.find(
        (req) =>
          req.resource.maxQuantity < req.quantity && !req.resource.hasStorage()
      );
      if (!unaffordableReq) {
        obj.resourceRequirements.forEach((requirement) => {
          requirement.resource.storageRequired = Math.max(
            requirement.quantity * bufferMult,
            requirement.resource.storageRequired
          );
        });
      }
    }
  ...
  function calculateRequiredStorages() {
    ...
    state.knowledgeRequiredByTechs = Math.max(
      0,
      ...state.techTargets.map((tech) =>
        resourceCost(tech, resources.Knowledge)
      )
    );
  ...
  function prioritizeDemandedResources() {
    ...
    if (prioritizedTasks.length > 0) {
      for (let i = 0; i < prioritizedTasks.length; i++) {
        ...
        for (let j = 0; j < demandedObject.resourceRequirements.length; j++) {
          ...
          resource.requestedQuantity = Math.max(
    ...
    for (let id in resources) {
      ...
      if (resource.isDemanded()) {
        ...
        for (let i = 0; i < resource.resourceRequirements.length; i++) {
          ...
          material.requestedQuantity = Math.max(
            material.requestedQuantity,
            material.maxQuantity * (resource.craftPreserve + 0.05)
          );
        }
      }
    }
    ...
    if (
      resources.Stanene.isDemanded() &&
      resources.Nano_Tube.storageRatio < factoryThreshold
    ) {
      resources.Nano_Tube.requestedQuantity = Math.max(
        resources.Nano_Tube.requestedQuantity,
        resources.Nano_Tube.maxQuantity * factoryThreshold
      );
    }
    if (
      resources.Nano_Tube.isDemanded() &&
      resources.Coal.storageRatio < factoryThreshold
    ) {
      resources.Coal.requestedQuantity = Math.max(
        resources.Coal.requestedQuantity,
        resources.Coal.maxQuantity * factoryThreshold
      );
    }
    if (
      resources.Furs.isDemanded() &&
      resources.Polymer.storageRatio < factoryThreshold
    ) {
      resources.Polymer.requestedQuantity = Math.max(
        resources.Polymer.requestedQuantity,
        resources.Polymer.maxQuantity * factoryThreshold
      );
    }
    // TODO: Prioritize missing consumptions of buildings
    // Force crafting Stanene up to 3% when we have Vitreloy Plants
    if (
      resources.Stanene.storageRatio < 0.03 &&
      buildings.Alien1VitreloyPlant.count > 0
    ) {
  ...
  function updatePriorityTargets() {
    ...
    state.queuedTargets = state.queuedTargetsAll.filter((obj) =>
      obj.isAffordable(true)
    );
    ...
    if (settings.autoEvolution && settings.evolutionBackup) {
      ...
      if (settings.userEvolutionTarget === "auto") {
        ...
        if (
          (settings.prestigeType === "ascension" ||
            settings.prestigeType === "demonic") &&
          newRace.isPillarUnlocked(stars)
        ) {
          for (let id in races) {
            let race = races[id];
            if (race.getHabitability() > 0 && !race.isPillarUnlocked(stars)) {
              GameLog.logWarning(
                GameLog.Types.special,
                `${newRace.name} pillar already infused, soft resetting and trying again.`,
          ...
          if (!needReset) {
            GameLog.logWarning(
              GameLog.Types.special,
              `All currently available pillars already infused. Continuing with current race.`,
              ["progress", "achievements"]
            );
          }
        }
        ...
        if (
          settings.prestigeType === "bioseed" &&
          newRace.isGreatnessAchievementUnlocked(stars)
        ) {
          for (let id in races) {
            let race = races[id];
            if (
              race.getHabitability() > 0 &&
              !race.isGreatnessAchievementUnlocked(stars)
            ) {
              GameLog.logWarning(
                GameLog.Types.special,
                `${newRace.name} greatness achievement already earned, soft resetting and trying again.`,
                ["progress", "achievements"]
              );
              needReset = true;
              break;
          ...
          if (!needReset) {
            GameLog.logWarning(
              GameLog.Types.special,
              `All currently available greatness achievements already earned. Continuing with current race.`,
              ["progress", "achievements"]
            );
          }
        }
        ...
        if (
          ...
          settings.prestigeType !== "ascension" &&
          settings.prestigeType !== "demonic" &&
          newRace.isMadAchievementUnlocked(stars)
        ) {
          for (let id in races) {
            let race = races[id];
            if (
              race.getHabitability() > 0 &&
              !race.isMadAchievementUnlocked(stars)
            ) {
              GameLog.logWarning(
                GameLog.Types.special,
                `${newRace.name} extinction achievement already earned, soft resetting and trying again.`,
                ["progress", "achievements"]
              );
              needReset = true;
              break;
          ...
          if (!needReset) {
            GameLog.logWarning(
              GameLog.Types.special,
              `All currently available extinction achievements already earned. Continuing with current race.`,
              ["progress", "achievements"]
            );
          }
        }
  ...
  function updateState() {
    if (game.global.race.species === "protoplasm") {
      ...
      if (settings.evolutionQueue.length > 0) {
        // Update star icons, we didn't had them in evolution, and used placeholder
    ...
    if (
      (state.lastLumber !== isLumberRace() && game.global.galaxy.trade) || // Outdated galaxyOffers
      state.lastWasteful !== game.global.race.wasteful
    ) {
      // Outdated craftCost
      state.goal = "GameOverMan";
        ...
        bodyMutation.addedNodes.forEach((node) => {
          if (
            ...
            if (WindowManager.openedByScript) {
              ...
              new MutationObserver(addTooltip).observe(node, {
                childList: true,
              });
            }
          }
  ...
  function buildFilterRegExp() {
    ...
    for (let i = 0; i < strings.length; i++) {
      ...
      let message =
        game.loc(id) + (id === "civics_garrison_gained" ? "%0" : "");
      if (message === id) {
        continue;
      }
      regexps.push(
  ...
  function getTooltipInfo(obj) {
    ...
    if (
      ...
      if (conflict) {
        notes.push(
          `Conflicts with ${conflict.target.title} for ${conflict.res.name} (${conflict.cause})`
        );
      }
    }
      ...
      mutation.addedNodes.forEach((node) => {
        if (node.id === "popper") {
          ...
          if (dataId === "powerStatus") {
            node.innerHTML += `<p class="modal_bd"><span>Disabled</span><span class="has-text-danger">${getNiceNumber(
              resources.Power.maxQuantity
            )}</span></p>`;
            return;
          } else if (infusionStep[dataId]) {
            let BloodStone = game
              .loc("resource_Blood_Stone_name")
              .replace(/[.*+?^${}()|[\]\\]/g, "\\$&");
            node.innerHTML = node.innerHTML.replace(
              new RegExp(`${BloodStone}: \\d+`),
              `$& (+${infusionStep[dataId]})`
            );
            return;
          }
          ...
          if (
            ...
            node.innerHTML += `<div id="popTimer" class="flair has-text-advanced">Contaminated in [${poly.timeFormat(
  ...
  function buildSettingsSection(
    ...
    $("#script_reset" + sectionId).on(
      "click",
      genericResetFunction.bind(null, resetFunction, sectionName)
    );
  }
  ...
  function addStandardHeading(node, heading) {
    node.append(
      '<div style="margin-top: 5px; width: 600px;"><span class="has-text-danger" style="margin-left: 10px;">' +
        heading +
        "</span></div>"
    );
  }
      ...
      .map(
        (item) =>
          `<option value="${item.val}" title="${item.hint}" ${
            item.val === settings[settingName] ? "selected" : ""
          }>${item.label}</option>`
      )
      .join();
    return $(`
  ...
  function addSettingsList(node, settingName, labelText, hintText, list) {
    ...
    let updateList = function () {
      let techsString = settings[settingName]
        .map(
    ...
    listBlock.on("click", "button:eq(0)", function () {
      if (selectedItem && settings[settingName].includes(selectedItem)) {
        settings[settingName].splice(
          settings[settingName].indexOf(selectedItem),
          1
        );
        settings[settingName].sort();
        updateSettingsFromState();
  ...
  function buildStandartSettingsInput(object, settingKey, property) {
    let textBox = $(
      '<input type="text" class="input is-small" style="height: 25px; width:100%"/>'
    );
  ...
  function buildStandartSettingsToggle(
    entity,
    property,
    toggleId,
    syncToggleId
    ...
    let toggle = $(
      '<label id="' +
        toggleId +
        '" tabindex="0" class="switch" style="position:absolute; margin-top: 8px; margin-left: 10px;"><input type="checkbox"' +
        checked +
        '> <span class="check" style="height:5px; max-width:15px"></span><span style="margin-left: 20px;"></span></label>'
    );

    toggle.on(
      "change",
      { entity: entity, property: property, sync: syncToggleId },
      toggleCallback
    );
  ...
  function toggleCallback(event) {
    event.data.entity[event.data.property] =
  ...
  function updateGeneralSettingsContent() {
    ...
    addSettingsToggle(
      currentNode,
      "triggerRequest",
      "Prioritize resources for triggers",
      "Readjust trade routes and production to resources required for active triggers. Missing resources will have 100 priority where applicable(autoMarket, autoGalaxyMarket, autoFactory, autoMiningDroid), or just 'top priority' where not(autoTax, autoCraft, autoCraftsmen, autoQuarry, autoSmelter)."
    );
    addSettingsToggle(
      currentNode,
      "queueRequest",
      "Prioritize resources for queue",
      "Readjust trade routes and production to resources required for buildings and researches in queue. Missing resources will have 100 priority where applicable(autoMarket, autoGalaxyMarket, autoFactory, autoMiningDroid), or just 'top priority' where not(autoTax, autoCraft, autoCraftsmen, autoQuarry, autoSmelter)."
    );
    addSettingsToggle(
      currentNode,
      "researchRequest",
    ...
    addSettingsToggle(
      ...
      "Readjust trade routes and production to resources required for unlocked and affordable missions. Missing resources will have 100 priority where applicable(autoMarket, autoGalaxyMarket, autoFactory, autoMiningDroid), or just 'top priority' where not(autoTax, autoCraft, autoCraftsmen, autoQuarry, autoSmelter)."
    );
    ...
    addSettingsToggle(
      ...
      "Save resources for queued buildings",
      "Script won't use resources needed for queued buildings. 'No Queue Order' game setting switches whether it save resources for next item, or whole queue."
    );
    addSettingsToggle(
      currentNode,
      "buildingsConflictRQueue",
      "Save resources for queued researches",
      "Script won't use resources needed for queued researches. 'No Queue Order' game setting switches whether it save resources for next item, or whole queue."
    );
    addSettingsToggle(
      currentNode,
      "buildingsConflictPQueue",
      "Save resources for queued projects",
      "Script won't use resources needed for queued projects. 'No Queue Order' game setting switches whether it save resources for next item, or whole queue."
    );
    ...
    addSettingsToggle(
      ...
      "Always assemble genes",
      "Will continue assembling genes even after De Novo Sequencing is researched"
    );
    addSettingsToggle(
      currentNode,
      "buildingAlwaysClick",
    ...
    addSettingsNumber(
      ...
      "Number of clicks performed at once, each second. Hardcapped by amount of missed resources"
    );
  ...
  function updatePrestigeSettingsContent(secondaryPrefix) {
    ...
    currentNode
      ...
      .on("change", function () {
        ...
        if (this.value === "mad" && haveTech("mad")) {
          confirmationText =
            "MAD has already been researched. You may prestige immediately. Are you sure you want to toggle this prestige?";
        } else if (this.value === "bioseed" && isBioseederPrestigeAvailable()) {
          confirmationText =
            "Required probes are built, and bioseeder ship is ready to launch. You may prestige immediately. Are you sure you want to toggle this prestige?";
        } else if (
          this.value === "cataclysm" &&
          isCataclysmPrestigeAvailable()
        ) {
          confirmationText =
            "Dial It To 11 is unlocked. You may prestige immediately. Are you sure you want to toggle this prestige?";
        } else if (
          this.value === "whitehole" &&
          isWhiteholePrestigeAvailable()
        ) {
          confirmationText =
            "Required mass is reached, and exotic infusion is unlocked. You may prestige immediately. Are you sure you want to toggle this prestige?";
        } else if (
          this.value === "ascension" &&
          isAscensionPrestigeAvailable()
        ) {
          confirmationText =
            "Ascension machine is built and powered. Custom race won't be changed. You may prestige immediately. Are you sure you want to toggle this prestige?";
        } else if (this.value === "demonic" && isDemonicPrestigeAvailable()) {
          confirmationText =
            "Required floor is reached, and demon lord is already dead. You may prestige immediately. Are you sure you want to toggle this prestige?";
        }
    ...
    addSettingsToggle(
      currentNode,
      "buildPopulation",
      "Build only population buildings"
    );
    addSettingsToggle(
      currentNode,
      "prestigeWaitAT",
      "Use all Accelerated Time",
      "Delay reset until all accelerated time will be used"
    );
    addSettingsToggle(
      currentNode,
    ...
    addSettingsNumber(
      ...
      "Percent of active barracks after unification",
      "Percent of barracks to keep enabled after unification, disabling some of them can reduce stress. All barracks will be enabled back when Bioseeder Ship will be at 90%, or after building World Collider"
    );
    ...
    addSettingsToggle(
      ...
      "Pre-MAD: Ignore A.R.P.A.",
      "Disables building A.R.P.A. projects until MAD is researched"
    );
    addSettingsToggle(
      currentNode,
      "prestigeMADWait",
    ...
    addSettingsToggle(
      ...
      "Enable mass ejector",
      "If not enabled the mass ejector will not be managed by the script"
    );
    addSettingsToggle(
      currentNode,
      "prestigeWhiteholeEjectExcess",
      "Eject excess resources",
      "Eject resources above amount required for buildings, normally only resources with full storages will be ejected, until 'Eject everything' option is activated."
    );
    addSettingsNumber(
      currentNode,
      "prestigeWhiteholeDecayRate",
      "(Decay Challenge) Eject rate",
      "Set amount of ejected resources up to this percent of decay rate, only useful during Decay Challenge"
    );
    addSettingsNumber(
      currentNode,
      "prestigeWhiteholeEjectAllCount",
      "Eject everything once X mass ejectors constructed",
      "Once we've constructed X mass ejectors the eject as much of everything as possible"
    );
    ...
    addSettingsToggle(
      ...
      "Skip Custom Race",
      "Perform reset without making any changes to custom. This option is required, script won't ascend automatically without it enabled."
    );
    addSettingsToggle(
      currentNode,
  ...
  function updateGovernmentSettingsContent(secondaryPrefix) {
    ...
    addSettingsToggle(
      currentNode,
      "govManage",
      "Manage changes of government",
      "Manage changes of government when they become available"
    );

    let governmentOptions = Object.keys(GovernmentManager.Types)
      .filter((id) => id !== "anarchy")
      .map((id) => ({
        val: id,
        label: game.loc(`govern_${id}`),
        hint: game.loc(`govern_${id}_desc`),
      }));
    addSettingsSelect(
      currentNode,
      "govInterim",
  ...
  function updateEvolutionSettingsContent() {
    ...
    addSettingsSelect(
      ...
      "Target Planet",
      "Chosen planet will be automatically selected after appropriate reset",
      planetOptions
    );
    ...
    let raceOptions = [
      {
        ...
        hint: "Picks race with not infused pillar for Ascension, with unearned Greatness achievement for Bioseed, or with unearned Extinction achievement in other cases. Conditional races are prioritized, when available.",
      },
    ...
    addSettingsSelect(
      ...
      let content = document.querySelector(
        "#script_evolutionSettings .script-content"
      );
      content.style.height = null;
      content.style.height = content.offsetHeight + "px";
    });
    ...
    addSettingsToggle(
      ...
      "evolutionBackup",
      "Soft Reset",
      "Perform soft resets until you'll get chosen race. Useless after getting mass exintion perk."
    );
    ...
    $("#script_evolutionQueueTable").sortable({
      ...
      update: function () {
        let evolutionIds = $("#script_evolutionQueueTable").sortable(
          "toArray",
          { attribute: "value" }
        );
  ...
  function buildEvolutionQueueItem(id) {
    ...
    let queueNode = $(`
      ...
      star.prop("outerHTML") ?? getAchievementLevel(queuedEvolution) - 1 + "*"
    }</td>
  ...
  function updatePlanetSettingsContent() {
    ...
    for (let i = 0; i < tableSize; i++) {
      ...
      if (i < biomeList.length) {
        tableElement.append(
          buildStandartLabel(game.loc("biome_" + biomeList[i] + "_name"))
        );
        tableElement = tableElement.next();
        tableElement.append(
          buildStandartSettingsInput(
            settings,
            "biome_w_" + biomeList[i],
            "biome_w_" + biomeList[i]
          )
        );
      } else {
      ...
      if (i < traitList.length) {
        tableElement.append(
          buildStandartLabel(
            i == 0 ? "None" : game.loc("planet_" + traitList[i])
          )
        );
        tableElement = tableElement.next();
        tableElement.append(
  ...
  function resetPlanetSettings() {
    biomeList.forEach(
      (biome) =>
        (settings["biome_w_" + biome] =
          (planetBiomes.length - planetBiomes.indexOf(biome)) * 10)
    );
    traitList.forEach(
      (trait) =>
        (settings["trait_w_" + trait] =
          (planetTraits.length - planetTraits.indexOf(trait)) * 10)
    );
  ...
  function addTriggerSetting() {
    ...
    let content = document.querySelector(
      "#script_triggerSettings .script-content"
    );
    content.style.height = null;
    content.style.height = content.offsetHeight + "px";
  }
  ...
  function buildTriggerRequirementId(trigger) {
    ...
    if (
      trigger.requirementType === "researched" ||
      trigger.requirementType === "unlocked"
    ) {
      triggerElement.append(
        buildTriggerListInput(techIds, trigger, "requirementId")
      );
    }
    if (trigger.requirementType === "built") {
      triggerElement.append(
        buildTriggerListInput(buildingIds, trigger, "requirementId")
      );
    }
  }
  ...
  function buildTriggerRequirementCount(trigger) {
    ...
    if (trigger.requirementType === "built") {
      triggerElement.append(
        buildTriggerCountInput(trigger, "requirementCount")
      );
    }
  }
  ...
  function buildTriggerActionId(trigger) {
    ...
    if (trigger.actionType === "research") {
      triggerElement.append(
        buildTriggerListInput(techIds, trigger, "actionId")
      );
    }
    if (trigger.actionType === "build") {
      triggerElement.append(
        buildTriggerListInput(buildingIds, trigger, "actionId")
      );
    }
    if (trigger.actionType === "arpa") {
      triggerElement.append(
        buildTriggerListInput(arpaIds, trigger, "actionId")
      );
    }
  }
  ...
  function buildTriggerSettingsColumn(trigger) {
    ...
    let deleteTriggerButton = $(
      '<a class="button is-dark is-small"><span>X</span></a>'
    );
    ...
    let theology2Options = [
      {
        val: "auto",
        label: "Script Managed",
        hint: "Picks Deify for Ascension prestige, and Study for others",
      },
      {
        val: "tech-study",
  ...
  function updateHellSettingsContent(secondaryPrefix) {
    ...
    addSettingsToggle(
      ...
      "disableHell",
      "Disable Hell",
      "Disables autoHell and sets attractor beacons to 0"
    );
    addSettingsNumber(
      currentNode,
      "maxSoulGems",
      "Max soul gems in ascension",
      "Disables autohell if the soul gem limit is reached in an ascension. 0 to never disable"
    );
    ...
    addSettingsToggle(
      ...
      "Automatically enter hell and adjust patrol count and hell garrison size",
      "Sets patrol count according to required garrison and patrol size"
    );
    addSettingsNumber(
      currentNode,
      "hellHomeGarrison",
  ...
  function updateFleetSettingsContent() {
    ...
    addSettingsToggle(
      ...
      "Adjusts ships distribution to fully supress piracy in prioritized regions. Some potential defence will be wasted, as it will use big ships to cover small holes, when it doesn't have anything fitting better. This option is not required: all your dreadnoughts still will be used even without this option."
    );
    addSettingsNumber(
      currentNode,
      "fleetEmbassyKnowledge",
      "Mininum knowledge for Embassy",
    ...
    addSettingsNumber(
      ...
      "Mininum knowledge for Alien Gift",
    ...
    addSettingsNumber(
      ...
      "Mininum knowledge for Alien 2 Assault",
    ...
    let priorityRegions = galaxyRegions
      .slice()
      .sort((a, b) => settings["fleet_pr_" + a] - settings["fleet_pr_" + b]);
    ...
    for (let i = 0; i < galaxyRegions.length; i++) {
      ...
      fleetElement.append(
        buildStandartLabel(typeof nameRef === "function" ? nameRef() : nameRef)
      );
    }
    ...
    $("#script_fleetTableBody").sortable({
      ...
      update: function () {
        let regionIds = $("#script_fleetTableBody").sortable("toArray", {
          attribute: "value",
        });
  ...
  function updateMechSettingsContent() {
    ...
    addSettingsSelect(
      ...
      "mechBuild",
      "Build mechs",
      "Configures what will be build. Infernal mechs won't ever be build.",
      buildOptions
    );
    ...
    addSettingsNumber(
      ...
      "Limiter for above option, maximum space used by collectors"
    );
    addSettingsNumber(
      currentNode,
    ...
    addSettingsToggle(
      currentNode,
      "mechSaveSupply",
      "Save up full supplies for next floor",
      "Stop building new mechs close to next floor, preparing to build bunch of new mechs suited for next enemy"
    );
    addSettingsToggle(
      currentNode,
      "mechFillBay",
  ...
  function calculateMechStats() {
    ...
    game.global.portal.mechbay = {
      ...
      mechs: new Array(Math.max(0, scouts)).fill({ size: "small" }),
    };
    game.global.blood.prepared = document.getElementById(
    ...
    if (realBay) {
      game.global.portal.mechbay = realBay;
    }
    if (realPrepared) {
      game.global.blood.prepared = realPrepared;
    }
  }
  ...
  function updateEjectorSettingsContent() {
    ...
    addSettingsToggle(
      ...
      "autoSupply",
      "Manage Supplies",
      "Send excess resources to Spire. Normal resources send when they're near storage cap, craftables - when above requirements. Takes priority over ejector."
    );
    ...
    for (let i = 0; i < tabResources.length; i++) {
      ...
      if (resource.isEjectable()) {
        ...
        ejectElement = ejectElement.next();
        ejectElement.append(
          buildStandartSettingsToggle(
            resource,
            "ejectEnabled",
            "script_eject2_" + resource.id,
            "script_eject1_" + resource.id
          )
        );
      } else {
      ...
      if (resource.isSupply()) {
        ejectElement = ejectElement.next();
        ejectElement.append(
          `<span class="mass">Export <span class="has-text-caution">${resource.supplyVolume}</span>, Gain <span class="has-text-success">${resource.supplyValue}</span></span>`
        );
        ...
        ejectElement.append(
          buildStandartSettingsToggle(
            resource,
            "supplyEnabled",
            "script_supply2_" + resource.id,
            "script_supply1_" + resource.id
          )
        );
      }
    }
  ...
  function resetEjectorState() {
    resourcesByAtomicMass.forEach(
      (resource) => (resource.ejectEnabled = resource.isTradable())
    );
    resourcesBySupplyValue.forEach(
      (resource) => (resource.supplyEnabled = resource.isTradable())
    );
  ...
  function updateMarketSettingsContent() {
    ...
    for (let i = 0; i < MarketManager.priorityList.length; i++) {
      ...
      marketElement.append(
        buildStandartSettingsToggle(
          resource,
          "autoBuyEnabled",
          "script_buy2_" + resource.id,
          "script_buy1_" + resource.id
        )
      );
      ...
      marketElement.append(
        buildStandartSettingsToggle(
          resource,
          "autoSellEnabled",
          "script_sell2_" + resource.id,
          "script_sell1_" + resource.id
        )
      );
      ...
      marketElement.append(
        buildStandartSettingsToggle(
          resource,
          "autoTradeBuyEnabled",
          "script_tbuy2_" + resource.id,
          "script_tbuy1_" + resource.id
        )
      );
      ...
      marketElement.append(
        buildStandartSettingsToggle(
          resource,
          "autoTradeSellEnabled",
          "script_tsell2_" + resource.id,
          "script_tsell1_" + resource.id
        )
      );
    ...
    $("#script_marketTableBody").sortable({
      ...
      update: function () {
        ...
        for (let i = 0; i < marketIds.length; i++) {
          ...
          MarketManager.priorityList.find(
            (resource) => resource.id === marketIds[i]
          ).marketPriority = i;
        }
    ...
    for (let i = 0; i < poly.galaxyOffers.length; i++) {
      ...
      marketElement.append(
        buildStandartLabel(buyResource.name, "has-text-success")
      );

      marketElement = marketElement.next();
      marketElement.append(
        buildStandartLabel(sellResource.name, "has-text-danger")
      );
      ...
      marketElement.append(
        buildStandartSettingsInput(
          buyResource,
          "res_galaxy_w_" + buyResource.id,
          "galaxyMarketWeighting"
        )
      );
      ...
      marketElement.append(
        buildStandartSettingsInput(
          buyResource,
          "res_galaxy_p_" + buyResource.id,
          "galaxyMarketPriority"
        )
      );
    }
  ...
  function updateStorageSettingsContent() {
    ...
    addSettingsToggle(
      ...
      "Assigns 3% more resources above required amounts, ensuring that required quantity will be actually reached, even if other part of script trying to sell\\eject\\switch production, etc."
    );
    addSettingsToggle(
      currentNode,
      "storagePrioritizedOnly",
      "Assign per buildings",
      "Assign storage based on individual costs of each enabled buildings, instead of going for maximums. Allows to prioritize storages for queue and trigger, and skip assigning for unaffordable expensive buildings. Experimental feature."
    );
    ...
    for (let i = 0; i < StorageManager.priorityList.length; i++) {
      ...
      storageElement.append(
        buildStandartSettingsToggle(
          resource,
          "autoStorageEnabled",
          "script_res_storage2_" + resource.id,
          "script_res_storage1_" + resource.id
        )
      );
      ...
      storageElement.append(
        buildStandartSettingsToggle(
          resource,
          "storeOverflow",
          "script_res_overflow2_" + resource.id,
          "script_res_overflow1_" + resource.id
        )
      );
    ...
    $("#script_storageTableBody").sortable({
      ...
      update: function () {
        ...
        for (let i = 0; i < storageIds.length; i++) {
          ...
          StorageManager.priorityList.find(
            (resource) => resource.id === storageIds[i]
          ).storagePriority = i;
        }
  ...
  function updateMinorTraitSettingsContent() {
    ...
    for (let i = 0; i < MinorTraitManager.priorityList.length; i++) {
      ...
      let toggle = $(
        `<span title="${game.loc(
          "trait_" + trait.traitName
        )}" class="has-text-info" style="margin-left: 20px;">${game.loc(
          "trait_" + trait.traitName + "_name"
        )}</span>`
      );
      ...
      minorTraitElement.append(
        buildStandartSettingsToggle(
          trait,
          "enabled",
          "script_mTrait_" + trait.traitName
        )
      );
    ...
    $("#script_minorTraitTableBody").sortable({
      ...
      update: function () {
        let minorTraitNames = $("#script_minorTraitTableBody").sortable(
          "toArray",
          { attribute: "value" }
        );
        ...
        for (let i = 0; i < minorTraitNames.length; i++) {
          ...
          MinorTraitManager.priorityList.find(
            (trait) => trait.traitName === minorTraitNames[i]
          ).priority = i;
        }
  ...
  function updateProductionTableSmelter(currentNode) {
    ...
    $("#script_productionTableBodySmelter").sortable({
      ...
      update: function () {
        let fuelIds = $("#script_productionTableBodySmelter").sortable(
          "toArray",
          { attribute: "value" }
        );
  ...
  function updateProductionTableFactory(currentNode) {
    ...
    addSettingsNumber(
      ...
      "Factory will craft resources only when all required material above given ration"
    );
    ...
    for (let i = 0; i < productionSettings.length; i++) {
      ...
      productionElement.append(
        buildStandartSettingsToggle(
          production,
          "enabled",
          "script_factory_" + production.resource.id
        )
      );
    ...
    for (let i = 0; i < state.craftableResourceList.length; i++) {
      ...
      productionElement.append(
        buildStandartSettingsToggle(
          resource,
          "autoCraftEnabled",
          "script_craft2_" + resource.id,
          "script_craft1_" + resource.id
        )
      );
  ...
  function updateProductionTableMiningDrone(currentNode) {
    ...
    for (let i = 0; i < droidProducts.length; i++) {
      ...
      productionElement.append(
        buildStandartSettingsInput(
          production,
          "droid_w_" + production.resource.id,
          "weighting"
        )
      );
      ...
      productionElement.append(
        buildStandartSettingsInput(
          production,
          "droid_pr_" + production.resource.id,
          "priority"
        )
      );
    }
  ...
  function updateProductionTablePylon(currentNode) {
    ...
    addSettingsNumber(
      ...
      "Mana income used",
      "Income portion to use on rituals. Setting to 1 is not recomended, as it will halt mana regeneration. Applied only when mana not capped - with capped mana script will always use all income."
    );
    ...
    for (let i = 0; i < pylonProducts.length; i++) {
      ...
      productionElement.append(
        buildStandartLabel(game.loc(`modal_pylon_spell_${production.id}`))
      );
  ...
  function updateJobSettingsContent() {
    ...
    addSettingsToggle(
      ...
      "jobSetDefault",
      "Set default job",
      "Automatically sets the default job in order of Quarry Worker -> Lumberjack -> Crystal Miner -> Scavenger -> Hunter -> Farmer"
    );
    addSettingsNumber(
      currentNode,
      "jobLumberWeighting",
      "Final Lumberjack Weighting",
      "AFTER allocating breakpoints this weighting will be used to split lumberjacks, quarry workers, crystal miners and scavengers"
    );
    addSettingsNumber(
      currentNode,
      "jobQuarryWeighting",
    ...
    addSettingsToggle(
      ...
      "Craft manually when possible",
      "Disable non-Scarletite crafters when manual craft is allowed"
    );
    ...
    for (let i = 0; i < JobManager.priorityList.length; i++) {
      const job = JobManager.priorityList[i];
      let classAttribute =
        job === jobs.Farmer || job === jobs.Hunter || job === jobs.Unemployed
          ? ' class="unsortable"'
          : ' class="script-draggable"';
    ...
    $("#script_jobTableBody").sortable({
      ...
      update: function () {
        ...
        for (let i = 0; i < jobIds.length; i++) {
          ...
          JobManager.priorityList.find(
            (job) => job._originalId === jobIds[i]
          ).priority = i + 3; // farmers, hunters, and unemployed is always on top
        }
  ...
  function buildJobSettingsToggle(job) {
    ...
    let color =
      job === jobs.Unemployed
        ...
        : "advanced";
    let toggle = $(
      '<label tabindex="0" class="switch" style="margin-top: 4px; margin-left: 10px;"><input type="checkbox"' +
        checked +
        '> <span class="check" style="height:5px; max-width:15px"></span><span class="has-text-' +
        color +
  ...
  function buildJobSettingsInput(job, breakpoint) {
    if (
      ...
      job === jobs.Hunter ||
      job instanceof CraftingJob ||
      (job !== jobs.Unemployed && breakpoint === 3 && job.isUnlimited())
    ) {
      let span = $("<span>Managed</span>");
      return span;
    }

    let jobBreakpointTextbox = $(
      '<input type="text" class="input is-small" style="height: 25px; width:100%;"/>'
    );
    jobBreakpointTextbox.val(
      settings["job_b" + breakpoint + "_" + job._originalId]
    );
  ...
  function updateWeightingSettingsContent() {
    ...
    addWeightingRule(
      tableBodyNode,
      "Not housing, barrack, or knowledge building",
  ...
  function updateBuildingSettingsContent() {
    ...
    addSettingsToggle(
      ...
      "Ignore weighting and build if storage is full",
    ...
    let newTableBodyText =
      '<tr value="All" class="unsortable"><td id="script_bldallToggle" style="width:35%"></td><td style="width:15%"></td><td style="width:15%"></td><td style="width:15%"></td><td style="width:20%"></td></tr>';
    ...
    buildingElement.append(
      buildAllBuildingEnabledSettingsToggle(BuildingManager.priorityList)
    );

    // state column
    buildingElement = buildingElement.next().next().next();
    buildingElement.append(
      buildAllBuildingStateSettingsToggle(BuildingManager.priorityList)
    );
    ...
    for (let i = 0; i < BuildingManager.priorityList.length; i++) {
      ...
      buildingElement.append(
        buildStandartSettingsToggle(
          building,
          "autoBuildEnabled",
          "script_bat2_" + building._vueBinding,
          "script_bat1_" + building._vueBinding
        )
      );
    ...
    $("#script_buildingTableBody").sortable({
      ...
      update: function () {
        let buildingElements = $("#script_buildingTableBody").sortable(
          "toArray",
          { attribute: "value" }
        );
        ...
        for (let i = 0; i < buildingElements.length; i++) {
          ...
          if (buildingElements[i] !== "All") {
            BuildingManager.priorityList.find(
              (building) => building._vueBinding === buildingElements[i]
            ).priority = i - 1;
          }
        }
  ...
  function filterBuildingSettingsTable() {
    ...
    if (reg?.length === 4) {
      ...
      switch (reg[1].trim()) {
        ...
        case "KNOWLEDGE":
          ...
          break;
        default:
          // Cost check, get resource quantity by name
          buildingValue = (b) =>
            b.resourceRequirements.find(
              (req) =>
                req.resource.title.toUpperCase().indexOf(reg[1].trim()) > -1
            )?.quantity ?? 0;
      }
      let testValue = null;
      switch (reg[3].trim()) {
      ...
      filterChecker = (building) =>
        eval(`${buildingValue(building)} ${reg[2]} ${testValue}`);
    }
    ...
    let content = document.querySelector(
      "#script_buildingSettings .script-content"
    );
    content.style.height = null;
    content.style.height = content.offsetHeight + "px";
  }
  ...
  function buildAllBuildingEnabledSettingsToggle(buildings) {
    ...
    let toggle = $(
      '<label tabindex="0" class="switch" style="position:absolute; margin-top: 8px; margin-left: 10px;"><input type="checkbox"' +
        checked +
        '> <span class="check" style="height:5px; max-width:15px"></span><span style="margin-left: 20px;"></span></label>'
    );
  ...
  function buildBuildingStateSettingsToggle(building) {
    ...
    if (building.isSwitchable()) {
      $(`<label id=script_bld_s_${
        building._vueBinding
      } tabindex="0" class="switch" style="position:absolute; margin-top: 8px; margin-left: 10px;">
                 <input type="checkbox" ${
                   building.autoStateEnabled ? "checked" : ""
                 }>
    ...
    if (building.is.smart) {
      $(`<label id=script_bld_s2_${
        building._vueBinding
      } tabindex="0" class="switch" style="position:absolute; margin-top: 8px; margin-left: 35px;">
                 <input type="checkbox" ${
                   building.autoStateSmart ? "checked" : ""
                 }>
                 <span class="check" style="height:5px; max-width:15px"></span><span style="margin-left: 20px;"></span>
               </label>`)
        .on("change", "input", function (event) {
          ...
          if (set) {
            set.forEach((building) => {
              ...
              document.querySelector(
                `#script_bld_s2_${building._vueBinding} input`
              ).checked = state;
            });
          } else {
            building.autoStateSmart = state;
    ...
    for (let i = 0; i < ProjectManager.priorityList.length; i++) {
      ...
      projectElement.append(
        buildStandartSettingsToggle(
          project,
          "autoBuildEnabled",
          "script_arpa2_" + project.id,
          "script_arpa1_" + project.id
        )
      );

      projectElement = projectElement.next();
      projectElement.append(
        buildStandartSettingsInput(project, "arpa_m_" + project.id, "_autoMax")
      );
    ...
    $("#script_projectTableBody").sortable({
      ...
      update: function () {
        ...
        for (let i = 0; i < projectIds.length; i++) {
          ...
          ProjectManager.priorityList.find(
            (project) => project.id === projectIds[i]
          ).priority = i;
        }
  ...
  function updateLoggingSettingsContent(secondaryPrefix) {
    ...
    Object.values(GameLog.Types).forEach((log) =>
      addSettingsToggle(
        ...
        log.settingKey,
        log.name,
        `If logging is enabled then logs ${log.name} actions`
      )
    );
  ...
  function createQuickOptions(
    ...
    let optionsDiv = $(
      `<div style="cursor: pointer;" id="${optionsElementId}">${optionsDisplayName} Options</div>`
    );
    node.append(optionsDiv);

    addOptionUI(
      optionsElementId + "_btn",
      `#${optionsElementId}`,
      optionsDisplayName,
      buildOptionsFunction
    );
    addOptionUiClickHandler(
      optionsDiv,
      optionsDisplayName,
      buildOptionsFunction
    );
  ...
  function createSettingToggle(
    ...
    let toggle = $(
      `<label id="${name}" tabindex="0" class="switch" title="${title}"><input type="checkbox"${
        settings[name] ? " checked" : ""
      }/> <span class="check"></span><span>${name}</span></label></br>`
    );
    node.append(toggle);
  ...
  function addOptionUiClickHandler(
    optionNode,
    modalTitle,
    buildOptionsFunction
  ) {
  ...
  function updateUI() {
    ...
    if (scriptNode.length === 0) {
      ...
      scriptNode.append(
        '<label id="autoScriptInfo">More script options available in Settings tab</label></br>'
      );
      ...
      createSettingToggle(
        scriptNode,
        "autoFight",
        "Sends troops to battle whenever Soldiers are full and there are no wounded. Adds to your offensive battalion and switches attack type when offensive rating is greater than the rating cutoff for that attack type."
      );
      createSettingToggle(
        scriptNode,
        "autoHell",
      ...
      createSettingToggle(
        scriptNode,
        "autoMech",
        "Builds most effective large mechs for current spire floor. Least effective will be scrapped to make room for new ones.",
        startMechObserver,
        stopMechObserver
      );
      createSettingToggle(
      ...
      createSettingToggle(
        scriptNode,
        "autoTax",
        "Adjusts tax rates if your current morale is greater than your maximum allowed morale. Will always keep morale above 100%."
      );
      createSettingToggle(
        scriptNode,
        "autoCraft",
      ...
      createSettingToggle(
        scriptNode,
        "autoStorage",
        "Assigns crates and containers to resources needed for buildings enabled for Auto Build, queued buildings, researches, and enabled projects",
        createStorageToggles,
        removeStorageToggles
      );
      createSettingToggle(
        scriptNode,
        "autoMarket",
        "Allows for automatic buying and selling of resources once specific ratios are met. Also allows setting up trade routes until a minimum specified money per second is reached. The will trade in and out in an attempt to maximise your trade routes.",
        createMarketToggles,
        removeMarketToggles
      );
      createSettingToggle(
      ...
      createSettingToggle(
        scriptNode,
        "autoCraftsmen",
        "With this option autoJobs will also manage craftsmens."
      );
      ...
      createSettingToggle(
        scriptNode,
        "autoAssembleGene",
        "Automatically assembles genes only when your knowledge is at max. Stops when DNA Sequencing is researched."
      );
      createSettingToggle(
        scriptNode,
        "autoMinorTrait",
        "Purchase minor traits using genes according to their weighting settings."
      );

      createQuickOptions(
        scriptNode,
        "s-quick-prestige-options",
        "Prestige",
    ...
    if (
      settings.prestigeWhiteholeEjectEnabled &&
    ...
    if (
      ...
      $("#mechList .ea-mech-info").length === 0
    ) {
      startMechObserver();
    }
    ...
    if (resources.Soul_Gem.isUnlocked()) {
      ...
      resources.Soul_Gem.rateOfChange =
        (gems / timePassed) * gameTicksPerSecond("mid");
  ...
  function startMechObserver() {
    ...
    createMechInfo();
    MechManager.mechObserver.observe(document.getElementById("mechLab"), {
      childList: true,
    });
  }
  ...
  function createArpaToggles() {
    ...
    for (let i = 0; i < ProjectManager.priorityList.length; i++) {
      ...
      if (projectElement.length) {
        let toggle = $(
          `<label id="script_arpa1_${
            project.id
          }" tabindex="0" class="switch ea-arpa-toggle" style="position:relative; max-width:75px;margin-top: -36px;left:59%;float:left;"><input type="checkbox"${
            project.autoBuildEnabled ? " checked" : ""
          }> <span class="check" style="height:5px;"></span></label>`
        );
        ...
        toggle.on(
          ...
          {
            entity: project,
            property: "autoBuildEnabled",
            sync: "script_arpa2_" + project.id,
          },
          toggleCallback
        );
      }
  ...
  function createCraftToggles() {
    ...
    for (let i = 0; i < state.craftableResourceList.length; i++) {
      ...
      if (craftableElement.length) {
        let toggle = $(
          `<label id="script_craft1_${
            craftable.id
          }" tabindex="0" class="switch ea-craft-toggle"><input type="checkbox"${
            craftable.autoCraftEnabled ? " checked" : ""
          }/> <span class="check" style="height:5px;"></span></label>`
        );
        ...
        toggle.on(
          ...
          {
            entity: craftable,
            property: "autoCraftEnabled",
            sync: "script_craft2_" + craftable.id,
          },
          toggleCallback
        );
      }
  ...
  function createBuildingToggles() {
    ...
    for (let i = 0; i < BuildingManager.priorityList.length; i++) {
      ...
      if (buildingElement.length) {
        let toggle = $(
          `<label id="script_bat1_${
            building._vueBinding
          }" tabindex="0" class="switch ea-building-toggle" style="position:absolute; margin-top: 24px;left:10%;"><input type="checkbox"${
            building.autoBuildEnabled ? " checked" : ""
          }/> <span class="check" style="height:5px; max-width:15px"></span></label>`
        );
        ...
        toggle.on(
          "change",
          {
            entity: building,
            property: "autoBuildEnabled",
            sync: "script_bat2_" + building._vueBinding,
          },
          toggleCallback
        );
  ...
  function createEjectToggles() {
    ...
    for (let i = 0; i < resourcesByAtomicMass.length; i++) {
      ...
      if (ejectElement.length) {
        let toggle = $(
          `<label id="script_eject1_${
            resource.id
          }" tabindex="0" title="Enable ejecting of this resource. When to eject is set in the Prestige Settings tab."  class="switch ea-eject-toggle" style="margin-left: auto; margin-right: 0.2rem;"><input type="checkbox"${
            resource.ejectEnabled ? " checked" : ""
        ...
        toggle.on(
          ...
          {
            entity: resource,
            property: "ejectEnabled",
            sync: "script_eject2_" + resource.id,
          },
          toggleCallback
        );
      }
  ...
  function createSupplyToggles() {
    ...
    for (let i = 0; i < resourcesBySupplyValue.length; i++) {
      ...
      if (supplyElement.length) {
        let toggle = $(
          `<label id="script_supply1_${
            resource.id
          }" tabindex="0" title="Enable supply of this resource."  class="switch ea-supply-toggle" style="margin-left: auto; margin-right: 0.2rem;"><input type="checkbox"${
            resource.supplyEnabled ? " checked" : ""
          }> <span class="check" style="height:5px;"></span><span class="state"></span></label>`
        );
        ...
        toggle.on(
          ...
          {
            entity: resource,
            property: "supplyEnabled",
            sync: "script_supply2_" + resource.id,
          },
          toggleCallback
        );
      }
    ...
    for (let resource of MarketManager.priorityList) {
      ...
      if (marketElement.length > 0) {
        ...
        if (!game.global.race["no_trade"]) {
          marketRow.append(
            $(
              `<label id="script_buy1_${
                resource.id
              }" tabindex="0" title="Enable buying of this resource."  class="switch"><input type="checkbox"${
                resource.autoBuyEnabled ? " checked" : ""
              }> <span class="check" style="height:5px;"></span><span class="state"></span></label>`
            ).on(
              "change",
              {
                entity: resource,
                property: "autoBuyEnabled",
                sync: "script_buy2_" + resource.id,
              },
              toggleCallback
            ),
            $(
              `<label id="script_sell1_${
                resource.id
              }" tabindex="0" title="Enable selling of this resource."  class="switch"><input type="checkbox"${
                resource.autoSellEnabled ? " checked" : ""
              }> <span class="check" style="height:5px;"></span><span class="state"></span></label>`
            ).on(
              "change",
              {
                entity: resource,
                property: "autoSellEnabled",
                sync: "script_sell2_" + resource.id,
              },
              toggleCallback
            )
          );
        ...
        marketRow.append(
          $(
            `<label id="script_tbuy1_${
              resource.id
            }" tabindex="0" title="Enable trading for this resource." class="switch"><input type="checkbox"${
              resource.autoTradeBuyEnabled ? " checked" : ""
            }> <span class="check" style="height:5px;"></span><span class="state"></span></label>`
          ).on(
            "change",
            {
              entity: resource,
              property: "autoTradeBuyEnabled",
              sync: "script_tbuy2_" + resource.id,
            },
            toggleCallback
          ),
          $(
            `<label id="script_tsell1_${
              resource.id
            }" tabindex="0" title="Enable trading this resource away." class="switch"><input type="checkbox"${
              resource.autoTradeSellEnabled ? " checked" : ""
            }> <span class="check" style="height:5px;"></span><span class="state"></span></label>`
          ).on(
            "change",
            {
              entity: resource,
              property: "autoTradeSellEnabled",
              sync: "script_tsell2_" + resource.id,
            },
            toggleCallback
          )
        );
    ...
    for (let resource of StorageManager.priorityList) {
      ...
      if (storageElement.length > 0) {
        $(
          ...
          .append(
            $(
              `<label id="script_res_storage1_${
                resource.id
              }" tabindex="0" title="Enable storing of this resource." class="switch"><input type="checkbox"${
                resource.autoStorageEnabled ? " checked" : ""
              }> <span class="check" style="height:5px;"></span><span class="state"></span></label>`
            ).on(
              "change",
              {
                entity: resource,
                property: "autoStorageEnabled",
                sync: "script_res_storage2_" + resource.id,
              },
              toggleCallback
            ),
            $(
              `<label id="script_res_overflow1_${
                resource.id
              }" tabindex="0" title="Enable storing overflow of this resource." class="switch"><input type="checkbox"${
                resource.storeOverflow ? " checked" : ""
              }> <span class="check" style="height:5px;"></span><span class="state"></span></label>`
            ).on(
              "change",
              {
                entity: resource,
                property: "storeOverflow",
                sync: "script_res_overflow2_" + resource.id,
              },
              toggleCallback
            )
          )
  ...
  function getUnsuitedMod() {
    return !game.global.blood.unbound
      ? 0
  ...
  function getCostConflict(action) {
    for (let i = 0; i < state.queuedTargets.length; i++) {
      ...
      for (let j = 0; j < otherObject.resourceRequirements.length; j++) {
        ...
        if (
          otherReq.resource !== resources.Knowledge &&
          otherReq.resource.currentQuantity < otherReq.quantity
        ) {
      ...
      for (let j = 0; j < otherObject.resourceRequirements.length; j++) {
        ...
        for (let k = 0; k < action.resourceRequirements.length; k++) {
          ...
          if (
            (resource !== resources.Knowledge || blockKnowledge) &&
            actionReq.resource === resource &&
            otherReq.quantity > resource.currentQuantity - actionReq.quantity
          ) {
  ...
  function resetMultiplier() {
    ...
    if (
      ...
      game.global.settings.mKeys
    ) {
      state.multiplierTick = state.scriptTick;
      document.dispatchEvent(
        new KeyboardEvent("keyup", { key: game.global.settings.keyMap.x10 })
      );
      document.dispatchEvent(
        new KeyboardEvent("keyup", { key: game.global.settings.keyMap.x25 })
      );
      document.dispatchEvent(
        new KeyboardEvent("keyup", { key: game.global.settings.keyMap.x100 })
      );
    }
  }
  ...
  function getStorage(resource, building, title, powered = false) {
    ...
    return count === 0
      ? parseFloat(
          building.definition
            .effect()
            .match(new RegExp(`(?<=\\+)[0-9]+(?= Max ${resource})`))[0]
        )
  ...
  var poly = {
    ...
    govPrice: function (e) {
      let i = game.global.civic.foreign[e],
        o = 15384 * i.eco;
      return (
        (o *= 1 + (1.6 * i.hstl) / 100),
        +(o *= 1 - (0.25 * i.unrest) / 100).toFixed(0)
      );
    },
      ...
      switch (t) {
        case "ruins": {
          let t = e || buildings.RuinsGuardPost.stateOnCount,
            ...
            a = game.armyRating(t, "hellArmy", 0);
          game.global.race.holy && (a *= 1.25);
          let l = (a + r) / 5e3;
    ...
    taxCap: function (e) {
      let a = haveTech("currency", 5);
      if (e)
        return (!a && !game.global.race.terrifying) || game.global.race.noble
          ? 10
          : 0;
      {
        let e = 30;
        return (
          game.global.race.noble
            ? (e = "oligarchy" === game.global.civic.govern.type ? 40 : 20)
            : ((e = "oligarchy" === game.global.civic.govern.type ? 50 : 30),
              (a || game.global.race.terrifying) && (e += 20)),
          "noble" === getGovernor() && (e += 10),
          e
        );
      }
    },
    // export function mechCost(size,infernal) from portal.js
    mechCost: function (e, a) {
      let l = 9999,
        r = 1e7;
      switch (e) {
        case "small":
          {
            let e = game.global.blood.prepared >= 2 ? 5e4 : 75e3;
        ...
        case "titan":
          ...
          break;
        case "collector": {
          let e = game.global.blood.prepared >= 2 ? 8e3 : 1e4;
          (r = a ? 2.5 * e : e), (l = 1);
        }
      }
      return { s: l, c: r };
    ...
    terrainRating: function (e, l, a) {
      if (
        (!e.equip.includes("special") ||
          ("small" !== e.size &&
            "medium" !== e.size &&
            "collector" !== e.size) ||
          (l < 1 && (l += (1 - l) * (a.includes("gravity") ? 0.1 : 0.2))),
        "small" !== e.size && l < 1)
      ) {
        let e = 0,
          i = { small: 0, medium: 0, large: 0, titan: 0, collector: 0 };
        for (let l = 0; l < game.global.portal.mechbay.mechs.length; l++) {
          let a = game.global.portal.mechbay.mechs[l];
          (e += MechManager.getMechSpace(a)) <=
            game.global.portal.mechbay.max && i[a.size]++;
        }
        (l +=
          (a.includes("fog") || a.includes("dark") ? 0.005 : 0.01) * i.small) >
          1 && (l = 1);
      }
      return l;
    },
    ...
    weaponPower: function (e, i) {
      return (
        i < 1 &&
          ...
          "titan" === e.size &&
          (i += 0.25 * (1 - i)),
        e.equip.includes("special") && "large" === e.size && (i *= 1.02),
        i
      );
    },
    ...
    adjustCosts: (cost, wiki) =>
      game.adjustCosts(
        cloneInto(cost, unsafeWindow, { cloneFunctions: true }),
        wiki
      ),
